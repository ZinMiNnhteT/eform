    ...
    <div class="card-deck mb-5">
        ...
        <div class="card">
            <div class="card-header bg-danger">
                <h4 class="card-title text-center text-white m-0">{{ __('lang.npt_meter_apply') }}</h4>
            </div>
            <div class="card-body">
                <ul class="list-unstyled other-meter-list">
                    <a href="{{ route('resident_rule_regulation',['div'=>'npt']) }}"><li class="meter-list-item">
                    <i class="fa fa-home m-r-20 text-danger"></i> {{ __('lang.residential_meter_apply') }}
                    ...
                    <a href="{{ route('resident_power_rule_regulation',['div'=>'npt']) }}"><li class="meter-list-item">
                        <i class="fa fa-building-o m-r-20 text-danger"></i> {{ __('lang.residential_power_meter_apply') }}
                        <span class="mytooltip tooltip-effect-4 m-l-20"> <span class="tooltip-item"><i class="fa fa-info text-danger"></i></span> <span class="tooltip-content clearfix"> <span class="tooltip-text bg-secondary text-dark">
                    ...
                    <a href="{{ route('commercial_rule_regulation',['div'=>'npt']) }}"><li class="meter-list-item">
                        <i class="fa fa-industry m-r-20 text-danger"></i> {{ __('lang.commercial_power_meter_apply') }}
                        <span class="mytooltip tooltip-effect-4 m-l-20"> <span class="tooltip-item"><i class="fa fa-info text-danger"></i></span> <span class="tooltip-content clearfix"> <span class="tooltip-text bg-secondary text-dark">
                    ...
                    <a href="{{ route('contract_rule_regulation',['div'=>'npt']) }}"><li class="meter-list-item">
                        <i class="fa fa-building m-r-20 text-danger"></i> {{ __('lang.contractor_meter_apply') }}
                        <span class="mytooltip tooltip-effect-4 m-l-20"> <span class="tooltip-item"><i class="fa fa-info text-danger"></i></span> <span class="tooltip-content clearfix"> <span class="tooltip-text bg-secondary text-dark">
                    ...
                    <a href="{{ route('tsf_rule_regulation_ygn',['div'=>'npt']) }}"><li class="meter-list-item">
                        <i class="fa fa-bolt m-r-20 text-danger"></i> {{ __('lang.home_transformer_apply') }}
                        <span class="mytooltip tooltip-effect-4 m-l-20"> <span class="tooltip-item"><i class="fa fa-info text-danger"></i></span> <span class="tooltip-content clearfix"> <span class="tooltip-text bg-secondary text-dark">
                    ...
                    <a href="{{ route('tsf_rule_regulation',['div'=>'npt']) }}"><li class="meter-list-item">
                        <i class="fa fa-bolt m-r-20 text-danger"></i> {{ __('lang.transformer_apply') }}
                        <span class="mytooltip tooltip-effect-4 m-l-20"> <span class="tooltip-item"><i class="fa fa-info text-danger"></i></span> <span class="tooltip-content clearfix"> <span class="tooltip-text bg-secondary text-dark">
                            <ul><span class="text-primary">{{__('lang.transformer_requirement')}}</span>
                                <li>{{__('lang.nrc_card')}}</li>
                                <li>{{__('lang.form10')}}</li>
                    ...
                    <a href="#"><li class="meter-list-item">
                        <i class="fa fa-superpowers m-r-20 text-danger"></i> {{ __('lang.village_meter_apply') }}
                        <span class="mytooltip tooltip-effect-4 m-l-20"> <span class="tooltip-item"><i class="fa fa-info text-danger"></i></span> <span class="tooltip-content clearfix"> <span class="tooltip-text bg-secondary text-dark">
