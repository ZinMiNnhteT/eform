    ...
    <div class="col-md-8 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endphp
                {!! Form::open(['route' => ['417_update_user_info_mdy'], 'method' => 'PATCH']) !!}
                    ...
                    <div class="col-md-12">
                        <div class="row justify-content-center">
                            <div class="col-md-3 mb-1">
                                <a href="{{ route('contractor_applied_form_mdy', $form->id) }}" class="waves-effect waves-light btn btn-block btn-rounded btn-secondary">{{ __('lang.cancel') }}</a>
                            </div>
                            <div class="col-md-3 mb-1">
