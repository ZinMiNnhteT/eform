    ...
    <div class="col-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::model($form, ['route' => ['commercial_update_user_info_mdy'], 'method' => 'PATCH', 'class' => 'form-horizontal mm']) !!}
                ...
                <div class="row justify-content-center">
                     <div class="col-md-8">
                        ...
                        <div class="otherWrapper {{ $form->job_type == 'other' ? : 'd-none' }}" id="otherWrap">
                            <div class="form-group input-required">
                                <label for="other" class="text-info">{{ __('lang.avg_salary') }} <span class="text-danger f-s-15">&#10039;</span></label>
                    ...
                    <div class="col-md-12">
                        <div class="row justify-content-center">
                            <div class="col-md-3">
                                <a href="{{ route('commercial_applied_form_mdy', $form->id) }}" class="waves-effect waves-light btn btn-block btn-rounded btn-secondary ">{{ __('lang.cancel') }}</a>
                            </div>
                            <div class="col-md-3">
