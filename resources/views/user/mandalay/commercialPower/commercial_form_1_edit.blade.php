    ...
    <div class="col-md-8 col-sm-12">
        <div class="card">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                ...
                                <tr class="text-center">
                                    ...
                                    <th class="{{ $item->sub_type == $form->apply_sub_type ? 'bg-warning' : '' }}">{{ __('lang.'.$item->slug) }}</th>
                                    @endforeach
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr class="text-center">
                                    <td></td>
                                    <td>
                                        {!! Form::open(['route' => ['commercial_update_meter_type_mdy'], 'method' => 'PATCH']) !!}
            ...
            <div class="card-footer text-center">
                <a href="{{ route('commercial_applied_form_mdy', $form->id) }}" class="col-md-3 waves-effect waves-light btn btn-rounded btn-secondary">@lang('lang.cancel')</a>
            </div>
        </div>
    </div>
</div>
