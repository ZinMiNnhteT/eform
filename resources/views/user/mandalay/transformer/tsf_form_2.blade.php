    ...
    <div class="col-md-8 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endphp
                {!! Form::open(['route' => ['tsf_store_user_info_mdy']]) !!}
                ...
                <div class="row justify-content-center ">
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <input type="checkbox" name="is_light" class="check" id="flat-checkbox-2" data-checkbox="icheckbox_flat-red">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="business_name" value="{{ __(null) }}" id="business_name" class="form-control {{ $errors->has('business_name') ? 'is-invalid' : '' }}">
                        </div>
                        {{--  Building Type  --}}
                        <div class="form-group">
