...
<div class="row justify-content-center py-5">
    <div class="col-md-8 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                {!! Form::model($form, ['route' => ['tsf_update_user_info_mdy'], 'method' => 'PATCH', 'class' => 'mm']) !!}
                {!! Form::hidden('form_id', $form_id) !!}
                <div class="row justify-content-center">
                     <div class="col-md-8">
                        <div class="form-group">
                            <input type="checkbox" name="religion" class="check" id="flat-checkbox-1" data-checkbox="icheckbox_flat-red" {{ !$form->is_religion ? : 'checked' }}>
                            <label for="flat-checkbox-1" class="text-primary">{{ __('lang.tsf_religion_msg') }}</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="is_light" class="check" id="flat-checkbox-2" data-checkbox="icheckbox_flat-red" {{ !$form->is_light ? : 'checked' }}>
                            <label for="flat-checkbox-2" class="text-primary">{{ __('lang.tsf_light_msg') }}</label>
                        </div>
                        {{--  Fullname  --}}
                        <div class="form-group">
                        ...
                        {{--  Business Name  --}}
                        <div class="form-group">
                            <label for="business_name" class="text-info">
                                {{ __('lang.business_name') }} ({{ __('lang.no_need_for_religion') }})
                            </label>
                            <input type="text" name="business_name" value="{{ $form->business_name }}" id="business_name" class="form-control {{ $errors->has('business_name') ? 'is-invalid' : '' }}">
                        </div>
                        {{--  Building Type  --}}
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="row justify-content-center">
                            <div class="col-md-2">
                                <a href="{{ route('tsf_applied_form_mdy', $form->id) }}" class="waves-effect waves-light btn btn-block btn-rounded btn-secondary ">{{ __('lang.cancel') }}</a>
                            </div>
                            <div class="col-md-2">
