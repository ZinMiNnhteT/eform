    ...
    <div class="col-md-8 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <br/>
                {!! Form::model($form, ['route' => ['resident_power_update_user_info_mdy'], 'method' => 'PATCH', 'class' => 'form-horizontal mm']) !!}
            ...
            <div class="card-footer text-center">
                <a href="{{ route('resident_power_applied_form_mdy', $form->id) }}" class="col-md-3 waves-effect waves-light btn btn-block btn-rounded btn-secondary ">{{ __('lang.cancel') }}</a>
