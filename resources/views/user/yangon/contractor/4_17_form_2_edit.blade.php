    ...
    <div class="col-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endphp
                {!! Form::open(['route' => '417_nrc_update_ygn', 'method' => 'PATCH', 'files' => true]) !!}
            ...
            <div class="card-footer text-center">
                <a href="{{ route('contractor_applied_form_ygn', $form->id) }}" class="col-3 waves-effect waves-light btn btn-secondary btn-rounded">{{ __('lang.cancel') }}</a>
