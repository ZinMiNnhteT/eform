    ...
    <div class="col-md-8 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::open(['route' => ['contractor_choose_form_ygn']]) !!}
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="apartment_count" class="form-control" placeholder="{{ __('lang.apartment_count') }}" id="apartment_count" required />
                                </div>
                                <div class="col-md-6">
                                    <label class="text-info">{{ __('lang.floor_count') }} <span class="text-danger f-s-15">&#10039;</span></label>
                                    <input type="number" name="floor_count" class="form-control" placeholder="{{ __('lang.floor_count') }}" id="floor_count" required />
                                </div>
                            </div>
                        </div>

                        {{-- အခန်းအရေအတွက် --}}
                        <input type="hidden" name="room_count" class="form-control" placeholder="{{ __('lang.room_count') }}" id="room" required />
            ...
            <div class="card-footer text-center">
                <a href="{{ route('contract_rule_regulation_ygn') }}" class="col-md-3 waves-effect waves-light btn btn-secondary btn-rounded mb-1">{{ __('lang.cancel') }}</a>
                <button type="submit" class="col-md-3 waves-effect waves-light btn btn-rounded btn-primary text-white">{{ __('lang.apply') }}</button>
            </div>
            {!! Form::close() !!}
        </div>
    </div>
