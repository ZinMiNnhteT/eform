    ...
    <div class="col-8">
        <div class="card">
            ...
            <div class="card-footer text-center">
                <a href="{{ route('contract_rule_regulation_ygn') }}" class="col-3 waves-effect waves-light btn btn-secondary btn-rounded mb-1">{{ __('lang.cancel') }}</a>
                <button type="submit" class="col-3 waves-effect waves-light btn btn-rounded btn-primary text-white">{{ __('lang.apply') }}</button>
            </div>
            {!! Form::close() !!}
        </div>
    </div>
