    ...
    <div class="col-md-8 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endphp
                {!! Form::open(['route' => ['417_update_user_info_ygn'], 'method' => 'PATCH']) !!}
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nrc" value="{{ $nrc }}" id="nrc" class="form-control {{ $errors->has('nrc') ? 'is-invalid' : '' }}" placeholder="{{__('lang.nrc_example')}}" required>   
                        </div>
                        {{-- Mobile --}}
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="row justify-content-center">
                            <div class="col-md-3 mb-1">
                                <a href="{{ route('contractor_applied_form_ygn', $form_id) }}" class="waves-effect waves-light btn btn-block btn-rounded btn-secondary">{{ __('lang.cancel') }}</a>
                            </div>
                            <div class="col-md-3 mb-1">
