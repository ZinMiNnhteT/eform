        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if($required == 'required')
                    ...
                    <br/>
                @endif
                {!! Form::open(['route' => ['resident_power_form10_update_ygn'], 'method' => 'PATCH', 'files' => true]) !!}
            ...
            <div class="card-footer text-center">
                <a href="{{ route('resident_power_applied_form_ygn', $form_id) }}" class="col-md-3 btn btn-rounded btn-secondary">{{ __('lang.cancel') }}</a>
