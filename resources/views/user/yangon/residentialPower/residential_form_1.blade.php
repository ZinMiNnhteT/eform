            ...
            <div class="container">
                ...
                <div class="card-body">
                    <div class="text-md-right m-b-5">
                        <a href="{{ route('resident_power_rule_regulation_ygn') }}" class="btn btn-rounded btn-info"><i class="fa fa-chevron-left"></i> @lang('lang.back')</a>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    <td></td>
                                    <td>
                                        {!! Form::open(['route' => ['resident_power_store_meter_type_ygn']]) !!}
                                        {!! Form::hidden('type', 1) !!}
