        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if($required == 'required')
                    ...
                    <br/>
                @endif
                {!! Form::open(['route' => 'resident_recomm_update_ygn', 'method' => 'PATCH', 'files' => true]) !!}
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="preview-wrapper">
                                <div class="front_preview text-center d-none">
                                    <img id="front_preview" src="" alt="Image Preview" class="img-responsive img-thumbnail"  data-toggle="modal" data-target="#myImg"/>
                                    <p class="m-t-10"><a href="" class="delete_front text-danger">Remove</a></p>
                                </div>
                            </div>
                            @if ($data1)
                            <div class="p-t-20 text-center">
                                <img src="{{ asset('storage/user_attachments/'.$form_id.'/'.$data1) }}" alt="{{ $data1 }}"  width="175" height="150" class="img-responsive img-thumbnail" data-toggle="modal" data-target="#myImg">
                            </div>
                            @endif
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="preview-wrapper">
                                <div class="back_preview text-center d-none">
                                    <img id="back_preview" src="" alt="Image Preview" class="img-responsive img-thumbnail"  data-toggle="modal" data-target="#myImg"/>
                                    <p class="m-t-10"><a href="" class="delete_back text-danger">Remove</a></p>
                                </div>
                            </div>
                            @if ($data2)
                            <div class="p-t-20 text-center">
                                <img src="{{ asset('storage/user_attachments/'.$form_id.'/'.$data2) }}" alt="{{ $data2 }}"  width="175" height="150" class="img-responsive img-thumbnail" data-toggle="modal" data-target="#myImg">
                            </div>
                            @endif
                        </div>
                    </div>
