    ...
    <div class="col-md-8 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @php
                    if (isset($form) && $form->count() > 0) {
                        ...
                        $applied_building = $form->applied_building;
                ...
                @endphp
                {!! Form::model($form, ['route' => ['resident_update_user_info_ygn'], 'method' => 'PATCH', 'class' => 'form-horizontal mm']) !!}
            ...
            <div class="card-footer text-center">
                <a href="{{ route('resident_applied_form_ygn', $form_id) }}" class="waves-effect waves-light btn btn-block btn-rounded btn-secondary col-md-3">{{ __('lang.cancel') }}</a>
