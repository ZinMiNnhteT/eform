    ...
    <div class="col-8">
        <div class="card">
                ...
                @php
                    if (count($files) > 0) {
                        foreach ($files as $file) {
                            ...
                            $data1 = $file->occupy_letter ? $file->occupy_letter : NULL;
                            $data2 = $file->no_invade_letter ? $file->no_invade_letter : NULL;
                        }
                    } else {
                        $data1 = $data2 = NULL;
                    }
                @endphp
                {!! Form::open(['route' => 'commercial_recomm_update_ygn', 'method' => 'PATCH', 'files' => true]) !!}
            ...
            <div class="card-footer text-center">
                <a href="{{ route('commercial_applied_form_ygn', $form->id) }}" class="col-3 waves-effect waves-light btn btn-rounded btn-secondary">{{ __('lang.cancel') }}</a>
