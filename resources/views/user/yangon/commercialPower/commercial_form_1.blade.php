    ...
    <div class="col-8">
        <div class="card">
            <div class="card-header bg-primary">
                <h4 class="text-center text-white">{{__('lang.meter_apply_type')}}</h4>
            </div>
            <div class="container">
                <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    <td></td>
                                    <td>
                                        {!! Form::open(['route' => ['commercial_store_meter_type_ygn']]) !!}
                                        {!! Form::hidden('type', 1) !!}
            ...
            <div class="card-footer text-center">
                <a href="{{ route('commercial_rule_regulation_ygn') }}" class="col-3 btn btn-rounded btn-info"><i class="fa fa-chevron-left"></i> @lang('lang.back')</a>
            </div>
        </div>
    </div>
</div>
