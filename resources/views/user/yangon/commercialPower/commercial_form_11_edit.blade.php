        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if($required == 'required')
                    ...
                    <br/>
                @endif
                {!! Form::open(['route' => 'commercial_bill_update_ygn', 'method' => 'PATCH','files' => true]) !!}
            ...
            <div class="card-footer text-center">
                <a href="{{ route('commercial_applied_form_ygn', $form->id) }}" class="waves-effect waves-light btn btn-secondary btn-rounded">{{ __('lang.cancel') }}</a>
