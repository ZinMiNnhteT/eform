...
<div class="row justify-content-center py-5">
    <div class="col-8">
        <div class="card">
            ...
            <div class="card-body">
                <div class="container">
                {!! Form::open(['route' => 'tsf_worklicence_update_ygn', 'method' => 'PATCH', 'files' => true]) !!}
        ...
        <div class="card-footer text-center">
            ...
            <a href="{{ route('tsf_applied_form_ygn', $form->id) }}" class="col-3 waves-effect waves-light btn btn-rounded btn-secondary">{{ __('lang.cancel') }}</a>
