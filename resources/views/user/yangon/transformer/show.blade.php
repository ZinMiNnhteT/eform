                    ...
                    <div id="app_show" class="accordion" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                @if (chk_send($form->id) !== 'first')
                                    @if ($form->serial_code)
                                <div class="ml-auto">
                                    <a href="{{ route('tsf_edit_user_info_ygn', $form->id) }}" class="btn-edit text-danger ">{{ __('lang.edit') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('tsf_edit_user_info_ygn', $form->id) }}" class="btn-edit text-info ">{{ __('lang.create') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                            <div id="info" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
                                <div class="container">
                                    <div class="card-body mm">
                                        ...
                                        @if($form->apply_tsf_type == '1')
                                            အိမ်သုံး
                                        @elseif($form->apply_tsf_type == '2')
                                            လုပ်ငန်းသုံး
                                        @endif
                                        ထရန်စဖော်မာ လျှောက်လွှာပုံစံ </b></h5>
                                        ...
                                        <div class="p-t-10">
                                            <h6>အကြောင်းအရာ။<span class="p-l-40">။</span> <b>{{ tsf_type($form->id) }}  တည်ဆောက် တပ်ဆင် ခွင့်ပြုပါရန် လျှောက်ထားခြင်း။</b></h6>
                                        </div>
                                        <div class="p-t-10">
                                            <h6 class="l-h-35">
                                                <span class="p-l-40"></span><span class="p-l-40"></span>
                                                အထက်ပါကိစ္စနှင့်ပတ်သက်၍ {{ address($form->id) }}နေ ကျွန်တော်/ကျွန်မ၏ <b>{!! $form->applied_building_type ? $form->applied_building_type : '<span class="p-l-40"></span>' !!}</b> တွင် {{ tsf_type($form->id) }} တပ်ဆင်သုံးစွဲခွင့်ပြုပါရန် လျှောက်ထားအပ်ပါသည်။
                                            </h6>
                                            <h6 class="l-h-35">
                            ...
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                <h5 class="mb-0 ">
                                    <a data-toggle="collapse" data-parent="#app_show" href="#typeOfMeter" aria-expanded="true" aria-controls="collapseOne">
                                        {{ __('lang.applied_plan_tsf') }}
                                    </a>
                                </h5>
                                @if (chk_send($form->id) !== 'first')
                                <div class="ml-auto">
                                    <a href="{{ route('tsf_edit_meter_type_ygn', $form->id) }}" class="btn-edit text-danger ">{{ __('lang.edit') }}</a>
                                </div>
                                @endif
                            </div>
                                    ...
                                    <div class="talbe-responsive p-20">
                                        <div class="alert alert-info">
                                            <strong>
                                                @if($form->pole_type == '1')
                                                    One Pole Type
                                                @elseif($form->pole_type == '2')
                                                    Two Pole Type
                                                @elseif($form->pole_type == '3')
                                                    Package Type
                                                @endif
                                            </strong>
                                        </div>
                                        <table class="table table-bordered">
                                            <thead>
                                                ...
                                                <tr class="text-center">
                                                    <th class="">{{ checkMM() === 'mm' ? mmNum(number_format($fee->name)) : number_format($fee->name) }} {{ __('lang.kva') }}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @php $total = 0; @endphp
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('tsf_nrc_edit_ygn', $form->id) }}" class="btn-edit text-info ">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('tsf_nrc_edit_ygn', $form->id) }}" class="btn-edit text-danger ">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                                ...
                                <div class="row text-center mt-2">
                                    <div class="col-md-6">
                                        <img src="{{ asset('storage/user_attachments/'.$form->id.'/'.$file->nrc_copy_front) }}" alt="{{ __('lang.nrc_front') }}" class="img-thumbnail" width="150" height="150" data-toggle="modal" data-target="#myImg">
                                            @if ($form->is_religion)
                                        <p class=" m-t-10 m-b-10">{{ __('သာသနာရေးကဒ်ရှေ့ဖက်') }}</p>
                                            @else
                                    ...
                                    <div class="col-md-6">
                                        <img src="{{ asset('storage/user_attachments/'.$form->id.'/'.$file->nrc_copy_back) }}" alt="{{ __('lang.nrc_back') }}" class="img-thumbnail" width="150" height="150" data-toggle="modal" data-target="#myImg">
                                            @if ($form->is_religion)
                                        <p class=" m-t-10 m-b-10">{{ __('သာသနာရေးကဒ်နောက်ဖက်') }}</p>
                                            @else
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('tsf_form10_edit_ygn', $form->id) }}" class="btn-edit text-info ">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('tsf_form10_edit_ygn', $form->id) }}" class="btn-edit text-danger ">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('tsf_recomm_edit_ygn', $form->id) }}" class="btn-edit text-info ">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('tsf_recomm_edit_ygn', $form->id) }}" class="btn-edit text-danger ">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('tsf_owner_edit_ygn', $form->id) }}" class="btn-edit text-info ">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('tsf_owner_edit_ygn', $form->id) }}" class="btn-edit text-danger ">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        @if (!$form->is_religion)
                        {{-- transaction license လုပ်ငန်းလိုင်စင်(သက်တမ်းရှိ/မူရင်း) --}}
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                <h5 class="mb-0">
                                ...
                                @if (chk_send($form->id) !== 'first')
                                    @if (chk_form_finish($form->id, $form->apply_type)['license'])
                                <div class="ml-auto">
                                    <a href="{{ route('tsf_worklicence_edit_ygn', $form->id) }}" class="btn-edit text-info ">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('tsf_worklicence_edit_ygn', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                            <div id="transaction_licence" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    ...
                                    <div class="col-md-6 text-center">
                                        <img src="{{ asset('storage/user_attachments/'.$form->id.'/'.$foto) }}" alt="{{ __('lang.transactionlicence_photo') }}" class="img-thumbnail" width="150" height="150" data-toggle="modal" data-target="#myImg">
                                        <p class="m-t-10 m-b-10">{{ __('lang.transactionlicence_photo') }}</p>
                                    </div>
                                            @endforeach
                                </div>
                                        @else
                        ...
                        {{-- dc recomanded စည်ပင်ထောက်ခံစာဓါတ်ပုံ --}}
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                <h5 class="mb-0">
                                ...
                                <div class="ml-auto">
                                    ...
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('tsf_electricpower_edit_ygn', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                            <div id="electricpower_letter" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    ...
                                    <div class="col-md-6 text-center">
                                        <img src="{{ asset('storage/user_attachments/'.$form->id.'/'.$foto) }}" alt="{{ __('lang.applied_dc_recomm_photo') }}" class="img-thumbnail" width="150" height="150" data-toggle="modal" data-target="#myImg">
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('tsf_farmland_edit_ygn', $form->id) }}" class="btn-edit text-info ">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('tsf_farmland_edit_ygn', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                            <div id="farmland" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                        @php
                                            $fotos = explode(',', $file->farmland);
                                        @endphp
                                            @foreach ($fotos as $foto)
                                    <div class="col-md-6 text-center">
                                        <img src="{{ asset('storage/user_attachments/'.$form->id.'/'.$foto) }}" alt="{{ __('lang.permit') }}" class="img-thumbnail" width="150" height="150" data-toggle="modal" data-target="#myImg">
                                        <p class="m-t-10 m-b-10">{{ __('lang.permit') }}</p>
                                    </div>
                                            @endforeach
                                </div>
                                        @else
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                @if (chk_send($form->id) !== 'first')
                                    @if (chk_form_finish($form->id, $form->apply_type)['industry'])
                                <div class="ml-auto">
                                    <a href="{{ route('tsf_industry_edit_ygn', $form->id) }}" class="btn-edit text-info ">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('tsf_industry_edit_ygn', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                            <div id="industry" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                        ...
                                        @endphp
                                            @foreach ($fotos as $foto)
                                    <div class="col-md-6 text-center">
                                        <img src="{{ asset('storage/user_attachments/'.$form->id.'/'.$foto) }}" alt="{{ __('lang.industry_zone_header') }}" class="img-thumbnail" width="150" height="150" data-toggle="modal" data-target="#myImg">
                                        <p class="m-t-10 m-b-10">{{ __('lang.industry_zone_header') }}</p>
                                    </div>
                                            @endforeach
                                </div>
                                        @else
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                <h5 class="mb-0 ">
                                    <a data-toggle="collapse" data-parent="#app_show" href="#electricpower" aria-expanded="true" aria-controls="collapseOne">{{ __('lang.applied_electricpower_photo') }}</a>
                                </h5>
                                @if (chk_send($form->id) !== 'first')
                                ...
                                {{-- @if (chk_send($form->id) !== 'first')
                                <div class="ml-auto">
                                    <a href="{{ route('resident_power_electricpower_edit_ygn', $form->id) }}" class="btn-edit text-danger ">{{ __('lang.edit') }}</a>
                                </div>
                                @endif --}}
                            </div>
                            <div id="electricpower" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                @foreach ($files as $file)
                                ...
                                <div class="row text-center mt-2">
                                    ...
                                    <div class="col-md-6 text-center">
                                        ...
                                        <p class=" m-t-10 m-b-10">{{ __('lang.electricpower_photo') }} ({{ checkMM()=='mm'?mmNum($i):$i }})</p>
                                    </div>
                                    @php
                                        $i++;
                                    @endphp
