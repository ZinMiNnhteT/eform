...
<div class="row justify-content-center py-5">
    <div class="col-md-8 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <br/>
                {!! Form::model($form, ['route' => ['commercial_update_user_info'], 'method' => 'PATCH', 'class' => 'form-horizontal mm']) !!}
                ...
                <div class="row justify-content-center">
                     <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::hidden('district_id', $form->district_id, ['id' => 'district_id','required']) !!}
                        </div>
                        {{--  Region  --}}
                        <div class="form-group">
                            ...
                            {!! Form::hidden('div_state_id', $form->div_state_id, ['id' => 'region_id','required']) !!}
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="row justify-content-center">
                            <div class="col-md-3">
                                <a href="{{ route('commercial_applied_form', $form->id) }}" class="waves-effect waves-light btn btn-block btn-rounded btn-secondary ">{{ __('lang.cancel') }}</a>
                            </div>
                            <div class="col-md-3">
