    ...
    <div class="col-md-8 col-sm-12">
        <div class="card">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    <td></td>
                                    <td>
                                        {!! Form::open(['route' => ['commercial_store_meter_type',$div]]) !!}
                                        {!! Form::hidden('type', 1) !!}
            ...
            <div class="card-footer text-center">
                <a href="{{ route('commercial_rule_regulation') }}" class="col-md-3 btn btn-rounded btn-info"><i class="fa fa-chevron-left"></i> @lang('lang.back')</a>
            </div>
        </div>
    </div>
</div>
