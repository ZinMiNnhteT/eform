...
<div class="row justify-content-center py-5">
    <div class="col-md-8 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="container">
                {!! Form::open(['route' => 'commercial_electricpower_update', 'method' => 'PATCH', 'files' => true]) !!}
            ...
            <div class="card-footer text-center">
                ...
                <a href="{{ route('commercial_applied_form', $form->id) }}" class="col-md-3 waves-effect waves-light btn btn-rounded btn-secondary">{{ __('lang.cancel') }}</a>
