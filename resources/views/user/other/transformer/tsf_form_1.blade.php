    ...
    <div class="col-10">
        <div class="card">
            <div class="card-header bg-primary">
                <h4 class="text-center text-white">{{__('lang.transformer_apply_type')}}</h4>
            </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {!! Form::open(['route' => ['tsf_store_meter_type']]) !!}
            ...
            <div class="card-footer text-center">
                <a href="{{ route('tsf_rule_regulation') }}" class="btn btn-rounded btn-info col-3"><i class="fa fa-chevron-left"></i> {{ __('lang.back') }}</a>
            </div>
        </div>
    </div>
</div>
