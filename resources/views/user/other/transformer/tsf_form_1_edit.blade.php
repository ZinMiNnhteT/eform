            ...
            <div class="container-fluid">
                <div class="card-body">
                    <div class="text-md-right m-b-5">
                        <a href="{{ route('tsf_applied_form', $form->id) }}" class="waves-effect waves-light btn btn-rounded btn-info"><< {{ __('lang.back') }}</a>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {!! Form::open(['route' => ['tsf_update_meter_type'], 'method' => 'PATCH']) !!}
