        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="container">
                    <div class="m-t-10 mm" id="">
                        <ul style="list-style-type: square" class="text-justify">
                            <li>
                                <p>လျှောက်ထားသူသည် ယခုအိမ်သုံးမီတာ လျှောက်ထားခြင်းအတွက် မည်သူကိုမျှ လာဘ်ငွေ၊ တံစိုးလက်ဆောင် တစ်စုံတစ်ရာ ပေးရခြင်းမရှိပါ။</p>
                            </li>
                            <li>
                ...
                <div class="text-center">
                    ...
                    <a href="{{ route('resident_meter_type',['div'=>$div]) }}" class="waves-effect waves-light btn btn-rounded btn-info rr-accept disabled ">{{ __('lang.continue') }}</a>
                </div>
            </div>
        </div>
    </div>
