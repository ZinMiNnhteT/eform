                    ...
                    <div id="app_show" class="accordion" role="tablist" aria-multiselectable="true">
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                @if (chk_send($form->id) !== 'first')
                                    @if ($form->serial_code)
                                <div class="ml-auto">
                                    <a href="{{ route('resident_power_edit_user_info', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('resident_power_edit_user_info', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                @if (chk_send($form->id) !== 'first')
                                <div class="ml-auto">
                                    <a href="{{ route('resident_power_edit_meter_type', $form->id) }}" class="btn-edit text-danger ">{{ __('lang.edit') }}</a>
                                </div>
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('resident_power_nrc_edit', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('resident_power_nrc_edit', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('resident_power_form10_edit', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('resident_power_form10_edit', $form->id) }}" class="btn-edit text-danger ">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('resident_power_recomm_edit', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('resident_power_recomm_edit', $form->id) }}" class="btn-edit text-danger ">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('resident_power_owner_edit', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('resident_power_owner_edit', $form->id) }}" class="btn-edit text-danger ">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
