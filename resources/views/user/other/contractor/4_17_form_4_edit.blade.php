    ...
    <div class="col-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endphp
                {!! Form::open(['route' => '417_recomm_update', 'method' => 'PATCH', 'files' => true]) !!}
            ...
            <div class="card-footer text-center">
                <a href="{{ route('contractor_applied_form_ygn', $form->id) }}" class="waves-effect waves-light btn btn-secondary btn-rounded">{{ __('lang.cancel') }}</a>
