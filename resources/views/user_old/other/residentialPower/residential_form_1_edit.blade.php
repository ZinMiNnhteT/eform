    ...
    <div class="col-md-8 col-sm-12">
        <div class="card">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    <td></td>
                                    <td>
                                        {!! Form::open(['route' => ['resident_power_update_meter_type'], 'method' => 'PATCH']) !!}
                                        {!! Form::hidden('type', 1) !!}
            ...
            <div class="card-footer text-center">
                <a href="{{ route('resident_power_applied_form', $form->id) }}" class="col-3 waves-effect waves-light btn btn-rounded btn-secondary ">@lang('lang.cancel')</a>
            </div>
        </div>
    </div>
</div>
