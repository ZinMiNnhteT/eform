            ...
            <div class="container">
                <div class="card-body">
                    <div class="text-md-right m-b-5">
                        <a href="{{ route('resident_applied_form', $form->id) }}" class="waves-effect waves-light btn btn-rounded btn-info "><< @lang('lang.back')</a>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    <td></td>
                                    <td>
                                        {!! Form::open(['route' => ['resident_update_meter_type'], 'method' => 'PATCH']) !!}
