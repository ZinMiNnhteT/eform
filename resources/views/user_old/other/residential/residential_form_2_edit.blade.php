    ...
    <div class="col-md-8 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <br/>
                {!! Form::model($form, ['route' => ['resident_update_user_info'], 'method' => 'PATCH', 'class' => 'form-horizontal mm']) !!}
                        ...
                        <div class="gStaff-wrapper {{ $form->job_type == 'gstaff' || $form->job_type == 'staff' ? : 'd-none' }}" id="gStaff-wrap">
                            <div class="form-group m-t-20">
                                ...
                                <div class="form-group m-t-20">
                                    ...
                                    <input type="number" name="salary" value="{{ $form->job_type == 'gstaff' || $form->job_type == 'staff' ? $form->salary : '' }}" id="salary" class="form-control" {{ $form->job_type == 'other' ? 'required' : '' }}/>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card-footer text-center">
                <a href="{{ route('resident_applied_form', $form->id) }}" class="waves-effect waves-light btn btn-block btn-rounded btn-secondary col-md-3">{{ __('lang.cancel') }}</a>
