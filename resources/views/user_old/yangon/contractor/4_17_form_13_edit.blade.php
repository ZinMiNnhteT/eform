        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if($required == 'required')
                    ...
                    <br/>
                @endif
                {!! Form::open(['route' => 'contractor_Drawing_photo_update_ygn', 'method' => 'PATCH', 'files' => true]) !!}
                {!! Form::hidden('form_id', $form_id, ['id' => 'form_id']) !!}
                    <div class="row">
                        <div class="col-12">
                            <h4 class="card-title ">{{ __('lang.drawing_photo') }} {!! $star !!}</h4>
                ...
                <div class="row m-t-10 m-b-10">
                    @foreach ($files as $file)
                        @if ($file->drawing)
                            @php $data = explode(',', $file->drawing); @endphp
                            @foreach ($data as $item)
