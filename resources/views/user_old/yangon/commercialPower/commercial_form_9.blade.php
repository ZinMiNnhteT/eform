    ...
    <div class="col-md-8 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <br/>
                <div class="container">
                {!! Form::open(['route' => 'commercial_farmland_store_ygn', 'files' => true]) !!}
            ...
            <div class="card-footer text-center">
                ...
                <a href="{{ route('commercial_building_photo_create_ygn',$form_id) }}" class="waves-effect waves-light btn btn-info btn-rounded col-md-3">{{ __('lang.continue') }}</a>
            </div>
