    ...
    <div class="col-md-8 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <br/>
                <div class="container">
                {!! Form::open(['route' => 'resident_power_farmland_store_ygn', 'files' => true]) !!}
                {!! Form::hidden('form_id', $form_id, ['id' => 'form_id']) !!}
                    <div class="row">
                        <div class="col-12">
                            <h4 class="card-title ">{{ __('lang.farmland_permit') }}</h4>
            ...
            <div class="card-footer text-center">
                ...
                <a href="{{ route('resident_power_building_photo_create_ygn',$form_id) }}" class="waves-effect waves-light btn btn-info btn-rounded col-md-3">{{ __('lang.continue') }}</a>
            </div>
