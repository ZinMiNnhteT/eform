    ...
    <div class="col-md-8 col-sm-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="container">
                {!! Form::open(['route' => 'tsf_industry_store_ygn', 'files' => true]) !!}
                {!! Form::hidden('form_id', $form_id, ['id' => 'form_id']) !!}
                    <div class="row">
                        <div class="col-12">
                            <h4 class="card-title">{{ __('lang.industry_zone') }} <span class="text-danger f-s-15">&#10039;</span></h4>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 alert alert-danger m-t-20">
                    <p class="card-title text-danger font-weight-bold m-0"><i class="fa fa-certificate"></i> {{ __('lang.industry_escape') }}</p>
                </div>
            </div>
            ...
            <div class="card-footer text-center">
                ...
                <a href="{{ route('tsf_electricpower_create_ygn',$form_id) }}" class="waves-effect waves-light btn btn-rounded btn-info">{{ __('lang.continue') }}</a>
            </div>
            {!! Form::close() !!}
        </div>
    </div>
