...
<div class="card-deck mb-5">
    <div class="card">
        ...
        <div class="card-body">
            <div class="text-center">
                <a href="{{ route('resident_rule_regulation_mdy') }}" class="btn waves-effect waves-light btn-rounded btn-info text-white">{{ __('lang.apply') }}</a>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="text-center">
                <a href="{{ route('resident_power_rule_regulation_mdy') }}" class="btn waves-effect waves-light btn-rounded btn-info text-white">{{ __('lang.apply') }}</a>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="text-center">
                <a href="{{ route('commercial_rule_regulation_mdy') }}" class="btn waves-effect waves-light btn-rounded btn-info text-white">{{ __('lang.apply') }}</a>
...
<div class="card-deck mb-5">
    ...
    <div class="card">
        ...
        <div class="card-body">
            {{-- <p class="text-danger text-center"><i class="fa fa-exclamation-circle fa-fw"></i> {{ 'Coming Soon!' }}</p> --}}
            <div class="text-center">
                <a href="{{ route('contract_rule_regulation_mdy') }}" class="btn waves-effect waves-light btn-rounded btn-info text-white">{{ __('lang.apply') }}</a>
            </div>
        </div>
    </div>
    <div class="card">
