    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header text-white bg-info d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('residentialMeterInstallationDoneList.index') }}" class="btn btn-rounded btn-info text-white l-h-ini p-t-5 p-b-5"><i class="fa-fw fa fa-angle-double-left"></i>{{ __('lang.back') }}</a>
                </div>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <a href="{{ route('residentialMeterInstallationDoneList.create', $data->id) }}" class="btn btn-rounded btn-info">{{ __('lang.send') }}</a>
            </div>
        </div>
    </div>
</div>
