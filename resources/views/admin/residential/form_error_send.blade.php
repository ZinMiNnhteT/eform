    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header text-white bg-info d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('residentialMeterApplicationList.show', $form_id) }}" class="btn btn-rounded btn-info text-white l-h-ini p-t-5 p-b-5"><i class="fa-fw fa fa-angle-double-left"></i>{{ __('lang.back') }}</a>
                </div>
            </div>
            <div class="card-body">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-3">
                        <a href="{{ route('residentialMeterApplicationList.show', $form_id) }}" class="btn btn-block btn-rounded btn-secondary">{{ __("lang.cancel") }}</a>
                    </div>
                    <div class="col-md-3">
