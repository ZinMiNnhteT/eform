    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::open(['route' => 'contractorMeterInstallationDoneList.index', 'method' => 'get']) !!}
                <div class="row mb-3">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="{{ route('contractorMeterInstallationDoneList.index') }}" class="btn btn-rounded btn-warning"><i class="fa fa-refresh text-white"></i></a>
                    </div>
                </div>
                {!! Form::close() !!}
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                @if (hasPermissions(['contractorInstallDone-create', 'contractorInstallDone-show']))
                        ...
                        @foreach ($form as $data)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    @if (hasPermissions(['contractorInstallDone-show']))
