    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header text-white bg-info d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('contractorMeterRejectedForm.index') }}" class="btn btn-rounded btn-info text-white l-h-ini p-t-5 p-b-5"><i class="fa-fw fa fa-angle-double-left"></i>{{ __('lang.back') }}</a>
                </div>
            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table no-border table-md-padding">
                                                ...
                                                @if($survey_result->remark_dist)
                                                    <tr>
                                                        <td>{{ ('ခရိုင်ရုံး ')}}{{ __('lang.remark') }}</td>
