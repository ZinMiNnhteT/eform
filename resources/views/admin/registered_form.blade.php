    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::open(['route' => 'registered_form.index', 'method'=>'get', 'id'=>'myForm']) !!}
                    <div class="row" id="resetAllDatas">
                        <div class="col-md-2">
                            <div class="form-group" id="searchDivision">
                                <select name="div_state_id" class="form-control s2 {{ checkMM() }}" id="filter_div_state">
                                    <option value="">{{ __('lang.division') }}{{ __('lang.choose1') }}</option>
                        ...
                        <div class="col-md-2">
                            <select name="meterType" class="form-control inner-form" id="type">
                                ...
                                <option value="4"> {{ __('lang.transformer') }}</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            ...
                            <a class="btn btn-rounded btn-warning dataReset"><i class="fa fa-refresh text-white"></i></a>
                        </div>
                    </div>
                {!! Form::close() !!}
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                @if (hasPermissions(['registeredForm-create', 'registeredForm-show']))
                        ...
                        @foreach ($form as $data)
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle">
                                    <a href="{{ route('registered_form.show', $data->id) }}" class="btn btn-rounded btn-sm btn-{{ chk_userForm($data->id)['to_confirm'] ? 'warning' : 'info' }}" data-toggle="tooltip" data-title="View"><i class="fa fa-search fa-fw"></i></a>
                                </td>
                                @endif
