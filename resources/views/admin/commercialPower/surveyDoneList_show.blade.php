    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header text-white bg-info d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('commercialPowerMeterGroundCheckDoneListDist.index') }}" class="btn btn-rounded btn-info text-white l-h-ini p-t-5 p-b-5"><i class="fa-fw fa fa-angle-double-left"></i>{{ __('lang.back') }}</a>
                </div>
            </div>
            <div class="card-body card-body-pb-div">
                ...
                <div id="app_show" class="accordion" role="tablist" aria-multiselectable="true">
                    ...
                    <div class="card mb-1">
                        <div class="card-header d-flex" role="tab" id="headingOne">
                            ...
                            @if (chk_userForm($data->id)['to_confirm_survey'])
                                @if (hasPermissionsAndGroupLvl(['commercialPowerTownshipChkGrd-edit'], admin()->group_lvl))
                                <div class="ml-auto">
                                ...
                                <div class="table-responsive">
                                    <table class="table no-border table-md-padding">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ __('lang.commercial') }} {{ __('lang.rdy_applied_cdt') }}</td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>{{ __('အင်ဂျင်နီယာ') }}{{ __('lang.remark') }}</td>
                                                <td>
                    ...
                    @if (chk_userForm($data->id)['to_confirm_dist'])
                        @if (hasPermissions(['commercialPowerDistrictChkGrd-create']))
                    <div class="card-header d-flex" role="tab" id="headingOne">
                        <h5 class="mb-0 text-info">{{ __('ခရိုင်အဆင့် စစ်ဆေးရန်') }}</h5>
                    </div>
                    <div class="card-body">
                        {!! Form::open(['route' => 'commercialPowerMeterGroundCheckDoneListDist.store']) !!}
                    ...
                    @endif
                    @if (chk_userForm($data->id)['to_confirm_survey'])
                        @if (hasPermissions(['commercialPowerTownshipChkGrd-create']))
                    <div class="card-header d-flex" role="tab" id="headingOne">
