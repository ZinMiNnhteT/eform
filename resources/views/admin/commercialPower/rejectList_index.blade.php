    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::open(['route' => 'commercialPowerMeterRejectedForm.index', 'method' => 'get']) !!}
                <div class="row mb-3">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="{{ route('commercialPowerMeterRejectedForm.index') }}" class="btn btn-rounded btn-warning"><i class="fa fa-refresh text-white"></i></a>
                    </div>
                </div>
                {!! Form::close() !!}
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                @if (hasPermissions(['commercialPowerReject-create', 'commercialPowerReject-show']))
                        ...
                        @foreach ($form as $data)
                            ...
                            <tr>
                                ...
                                @if (hasPermissions(['commercialPowerReject-show']))
                                <td class="text-center align-middle">
                                    <a href="{{ route('commercialPowerMeterRejectedForm.show', $data->id) }}" class="btn btn-rounded btn-sm btn-info" data-toggle="tooltip" data-title="View"><i class="fa fa-search fa-fw"></i></a>
                                </td>
                                @endif
