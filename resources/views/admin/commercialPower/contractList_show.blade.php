    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header text-white bg-info d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('commercialPowerMeterContractList.index') }}" class="btn btn-rounded btn-info text-white l-h-ini p-t-5 p-b-5"><i class="fa-fw fa fa-angle-double-left"></i>{{ __('lang.back') }}</a>
                </div>
            </div>
            <div class="card-body card-body-pb-div">
                ...
                <div class="container-fluid">
                    <div id="app_show" class="accordion" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                <h5 class="mb-0">
                                    <a data-toggle="collapse" data-parent="#app_show" href="#electricpower_letter" aria-expanded="true" aria-controls="collapseOne">{{ __('lang.electricpower') }}</a>
                                </h5>
                            </div>
                ...
                @if (chk_userForm($data->id)['to_contract'])
                    ...
                    <div class="row justify-content-center m-t-20 m-b-10">
                        <div class="col-3">
                            <a href="{{ route('commercialPowerMeterContractList.create', $data->id) }}" class="btn btn-rounded btn-block btn-warning" data-toggle="tooltip" data-title="To Contract">
                                {{ __('lang.survey') }}
                            </a>
                        </div>
                    </div>
