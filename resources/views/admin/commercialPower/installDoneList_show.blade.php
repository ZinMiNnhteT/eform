    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header text-white bg-info d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('commercialPowerMeterInstallationDoneList.index') }}" class="btn btn-rounded btn-info text-white l-h-ini p-t-5 p-b-5"><i class="fa-fw fa fa-angle-double-left"></i>{{ __('lang.back') }}</a>
                </div>
            </div>
            <div class="card-body card-body-pb-div">
                ...
                <div class="container-fluid">
                    <div id="app_show" class="accordion" role="tablist" aria-multiselectable="true">
                                    ...
                                    <div class="talbe-responsive p-20">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                @if ($col_name != 'id' && $col_name != 'type' && $col_name != 'name' && $col_name != 'created_at' && $col_name != 'updated_at' && $col_name != 'slug')
                                                <tr>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                <h5 class="mb-0">
                                    <a data-toggle="collapse" data-parent="#app_show" href="#transaction_letter" aria-expanded="true" aria-controls="collapseOne">{{ __('lang.transactionlicence') }}</a>
                                </h5>
                            </div>
                ...
                @if (chk_userForm($data->id)['to_confirm_install'])
                    @if (hasPermissions(['commercialPowerInstallDone-create']))
                    <div class="row justify-content-center m-t-20 m-b-10">
                        <div class="col-3">
                            <button class="btn btn-rounded btn-block btn-warning" data-toggle="modal" data-target="#confirm_install" data-backdrop="static" data-keyboard="false" title="To Install Meter">
                                    {{ __('lang.confirm_install') }}
                            </button>
                        </div>
                    </div>
                    @endif
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <a href="{{ route('commercialPowerMeterInstallationDoneList.create', $data->id) }}" class="btn btn-rounded btn-info">{{ __('lang.send') }}</a>
            </div>
        </div>
    </div>
</div>
