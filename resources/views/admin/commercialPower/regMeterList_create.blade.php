        ...
        <div class="card">
            ...
            <div class="card-body mm">
                ...
                <div class="container">
                    ...
                    <div class="row form-group mb-1">
                        <label for="meter_no" class="control-label l-h-35 text-md-right col-md-3">မီတာအမှတ်</label>
                        <div class="col-md-7">
                    ...
                    <div class="row form-group mb-1">
                        <label for="who_made_meter" class="control-label l-h-35 text-md-right col-md-3">မီတာလုပ်သူ</label>
                        <div class="col-md-7">
                            {!! Form::text('who_made_meter', null, ['id' => 'who_made_meter', 'class' => 'form-control inner-form']) !!}
                        </div>
                    </div>
                    <div class="row form-group mb-1">
                        <label for="ampere" class="control-label l-h-35 text-md-right col-md-3">အမ်ပီယာ</label>
                        <div class="col-md-7">
                ...
                <div class="text-center mt-5">
                    <a href="{{ url('commercialPowerMeterRegisterMeterList') }}" class="btn btn-rounded btn-secondary">{{ __('lang.cancel') }}</a>
