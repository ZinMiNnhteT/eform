    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header bg-info text-white">
                <h5 class="card-title m-0">{{ __('lang.commercial') }} {{ __('lang.power') }} {{ __('lang.meter') }} {{ __('lang.'.$heading) }} {{ __('lang.forms') }}</h5>
            </div>
            ...
            <div class="card-body">
                ...
                {!! Form::open(['route' => 'commercialPowerMeterPendingForm.index', 'method' => 'get']) !!}
                <div class="row mb-3">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="{{ route('commercialPowerMeterPendingForm.index') }}" class="btn btn-rounded btn-warning"><i class="fa fa-refresh text-white"></i></a>
                    </div>
                </div>
                {!! Form::close() !!}
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                @if (hasPermissions(['commercialPowerPending-create', 'commercialPowerPending-show']))
                        ...
                        @foreach ($form as $data)
                            ...
                            <tr>
                                ...
                                @if (hasPermissions(['commercialPowerPending-show']))
                                <td class="text-center align-middle">
                                    <a href="{{ route('commercialPowerMeterPendingForm.show', $data->id) }}" class="btn btn-rounded btn-sm btn-{{ chk_userForm($data->id)['pending'] ? 'warning' : 'info' }}" data-toggle="tooltip" data-title="View"><i class="fa fa-search fa-fw"></i></a>
                                </td>
                                @endif
