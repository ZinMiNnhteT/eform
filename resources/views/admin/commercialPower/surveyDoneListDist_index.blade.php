    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::open(['route' => 'commercialPowerMeterGroundCheckDoneListDist.index', 'method' => 'get']) !!}
                <div class="row mb-3">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="{{ route('commercialPowerMeterGroundCheckDoneListDist.index') }}" class="btn btn-rounded btn-warning"><i class="fa fa-refresh text-white"></i></a>
                    </div>
                </div>
                {!! Form::close() !!}
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                @if (hasPermissions(['commercialPowerDistrictChkGrd-create', 'commercialPowerDistrictChkGrd-show']))
                        ...
                        @foreach ($form as $data)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if (hasPermissions(['commercialPowerDistrictChkGrd-show']))
                                    <a href="{{ route('commercialPowerMeterGroundCheckDoneListDist.show', $data->id) }}" class="btn btn-{{ chk_userForm($data->id)['to_confirm_dist'] ? 'warning' : 'info' }} btn-sm btn-rounded" data-toggle="tooltip" data-title="View"><i class="fa fa-search fa-fw"></i></a>
                                    @endif
                                </td>
                                @endif
                            </tr>
