    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header text-white bg-info d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('commercialPowerMeterPaymentList.index') }}" class="btn btn-rounded btn-info text-white l-h-ini p-t-5 p-b-5"><i class="fa-fw fa fa-angle-double-left"></i>{{ __('lang.back') }}</a>
                </div>
            </div>
            <div class="card-body card-body-pb-div">
                ...
                <div class="container-fluid">
                    ...
                    @if (chk_userForm($data->id)['to_confirm_pay'])
                        @if (hasPermissions(['commercialPowerConfirmPayment-create']))
                        <div class="card mb-1">
                            ...
                            <div class="card-body">
                                <div class="row justify-content-center">
                                    <div class="col-8">
                                        ...
                                        <div class="form-group row mb-1">
                                            <label class="control-label col-md-3">{{ __('lang.composit_box') }}</label>
                                            <div class="col-md-6">
                                                <p>{{ checkMM() === 'mm' ? mmNum(number_format($sub_type->composit_box)) : number_format($sub_type->composit_box) }}</p>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-1">
                                ...
                                <br/>
                                {!! Form::open(['route' => 'commercialPowerMeterPaymentList.store', 'files' => true]) !!}
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-8 form-group mm">
                                        ...
                                        <input type="text" name="accept_date" class="form-control mydatepicker" placeholder="ငွေသွင်းလက်ခံသည့် နေ့ ဖြည့်သွင်းရန်" required>
                                    </div>
                                    <div class="col-md-8 form-group mm">
                                    ...
                                    <div class="col-md-8 form-group mm">
                                        <div class="form-group">
                                            <label for="payment_accepted_slips"> {{ __('ပြေစာဖြတ်ပိုင်းများတွဲရန်') }}</label><br>
                                    ...
                                    <div class="col-md-8 text-center">
                                        <input type="submit" name="confirm_pay_submit" value="{{ __('lang.approve') }}" class="btn btn-rounded btn-info" required>
                                    </div>
                                </div>
                                {!! Form::close() !!}
                            </div>
