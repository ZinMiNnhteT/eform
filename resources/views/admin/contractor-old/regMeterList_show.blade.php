        ...
        <div class="card">
            ...
            <div class="card-body card-body-pb-div">
                ...
                @if (chk_userForm($data->id)['to_register'])
                    @if (hasPermissions(['residentialRegisteredMeter-create']))
                    <div class="row justify-content-center m-t-20 m-b-10">
                        <div class="col-3">
                            <a href="{{ route('contractorMeterRegisterMeterList.create', $data->id) }}" class="btn btn-rounded btn-block btn-warning" data-toggle="tooltip" data-title="To Register Meter">
                                {{ __('lang.register_meter') }}
                            </a>
                        </div>
                    </div>
                    @endif
