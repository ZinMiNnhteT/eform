                ...
                @if (chk_userForm($data->id)['to_survey'])
                    @if(hasSurvey($data->id))
                        ...
                        <div class="row justify-content-center m-t-20 m-b-10">
                            <div class="col-3">
                                <a href="{{ route('contractorMeterGroundCheckList.create', $data->id) }}" class="btn btn-warning" data-toggle="tooltip" data-title="To Fill Survey Result">
                                    {{ __('lang.survey') }}
                                </a>
                            </div>
                        </div>
                    ...
                    @else
                        @if (chk_userForm($data->id)['to_survey'])
                            @if (hasPermissionsAndGroupLvl(['residentialGrdChk-create'], admin()->group_lvl)) {{--  if login-user is from township  --}}
                                <div class="row justify-content-center m-t-20 m-b-10">
                                    <div class="col-3">
                                        <a href="{{ route('contractorMeterGroundCheckChoose.create', $data->id) }}" class="btn btn-warning" data-toggle="tooltip" data-title="To Choose Eningeer">
