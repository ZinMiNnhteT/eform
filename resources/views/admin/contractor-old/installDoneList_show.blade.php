        ...
        <div class="card">
            ...
            <div class="card-body card-body-pb-div">
                ...
                @if (chk_userForm($data->id)['ei_confirm'])
                    @if (hasPermissions(['residentialInstallDone-create']))
                    <div class="row justify-content-center m-t-20 m-b-10">
                        <div class="col-3">
                            <a href="{{ route('contractorMeterInstallationDoneList.create', $data->id) }}" class="btn btn-rounded btn-block btn-warning">{{ __('lang.ei_confirm') }}</a>
                        </div>
                    </div>
                    @endif
                @endif
