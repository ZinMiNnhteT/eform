            ...
            <div class="card-body card-body-pb-div">
                ...
                <div class="container-fluid">
                    <div id="app_show" class="accordion" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                <h5 class="mb-0">
                                    <a data-toggle="collapse" data-parent="#app_show" href="#tsf_info" aria-expanded="true" aria-controls="collapseOne">
                                        {{ __('lang.built_tsf_info') }}
                                    </a>
                                </h5>
                            </div>
                            <div id="tsf_info" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                @foreach ($files as $file)
                                <div class="row text-center mt-2">
                                    @php
                                        $tsf_foto = explode(',', $file->tsf_info);
                                        $i = 1;
                                    @endphp
                                    @foreach ($tsf_foto as $foto)
                                    <div class="col-md-6 text-center">
                                        <img src="{{ asset('public/storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$foto) }}" alt="{{ $foto }}" class="img-thumbnail">
                                        <p class="m-t-10 m-b-10">{{ __('lang.built_tsf_info') }} ({{ checkMM()=='mm'?mmNum($i):$i }})</p>
                                    </div>
                                    @php $i++; @endphp
                                    @endforeach
                                </div>
                ...
                @if (chk_userForm($data->id)['to_chk_install'])
                    ...
                    <div class="row justify-content-center m-t-20 m-b-10">
                        <div class="col-3">
                            <a href="{{ route('contractorMeterCheckInstallList.create', $data->id) }}" class="btn btn-rounded btn-block btn-warning" data-toggle="tooltip" data-title="To Check To Install">
                                {{ __('lang.chk_install') }}
                            </a>
                        </div>
                    </div>
