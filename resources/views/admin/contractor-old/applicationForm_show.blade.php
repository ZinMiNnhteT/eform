    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body card-body-pb-div">
                ...
                @if ($data->apply_type == 5 && $data->apply_sub_type == 1)
                    ...
                    <div id="app_show" class="accordion" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="card mb-1">
                            ...
                            <div id="nrc" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    <div class="col-md-6">
                                        <img src="{{ asset('public/storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$file->nrc_copy_front) }}" alt="{{ $file->nrc_copy_front }}" class="img-thumbnail">
                                        <p class="m-t-10 m-b-10">{{ __('lang.nrc_front') }}</p>
                                    </div>
                                    <div class="col-md-6">
                                        <img src="{{ asset('public/storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$file->nrc_copy_back) }}" alt="{{ $file->nrc_copy_back }}" class="img-thumbnail">
                        ...
                        <div class="card mb-1">
                            ...
                            <div id="form10" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    <div class="col-md-6">
                                        <img src="{{ asset('public/storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$file->form_10_front) }}" alt="{{ $file->form_10_front }}" class="img-thumbnail">
                                        <p class="m-t-10 m-b-10">{{ __('lang.form10_front') }}</p>
                                    </div>
                                    @if ($file->form_10_back)
                                    <div class="col-md-6">
                                        <img src="{{ asset('public/storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$file->form_10_back) }}" alt="{{ $file->form_10_back }}" class="img-thumbnail">
                        ...
                        <div class="card mb-1">
                            ...
                            <div id="recommanded_letter" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    <div class="col-md-6">
                                        <img src="{{ asset('public/storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$file->occupy_letter) }}" alt="{{ $file->occupy_letter }}" class="img-thumbnail">
                                        <p class="m-t-10 m-b-10">{{ __('lang.occupy_letter') }}</p>
                                    </div>
                                    <div class="col-md-6">
                                        <img src="{{ asset('public/storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$file->no_invade_letter) }}" alt="{{ $file->noinvade_letter }}" class="img-thumbnail">
                            ...
                            <div id="owner_letter" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    ...
                                    <div class="col-md-6 text-center">
                                        <img src="{{ asset('public/storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$foto) }}" alt="{{ $foto }}" class="img-thumbnail">
                        ...
                        <div class="card mb-1">
                            ...
                            <div id="permit_letter" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    <div class="col-md-6">
                                        <img src="{{ asset('public/storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$file->building_permit) }}" alt="{{ $file->building_permit }}" class="img-thumbnail">
                        ...
                        <div class="card mb-1">
                            ...
                            <div id="bcc_letter" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    <div class="col-md-6">
                                        <img src="{{ asset('public/storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$file->bcc) }}" alt="{{ $file->bcc }}" class="img-thumbnail">
                        ...
                        <div class="card mb-1">
                            ...
                            <div id="dc_recomm_letter" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    <div class="col-md-6">
                                        <img src="{{ asset('public/storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$file->dc_recomm) }}" alt="{{ $file->dc_recomm }}" class="img-thumbnail">
                        ...
                        <div class="card mb-1">
                            ...
                            <div id="prev_bill_letter" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    <div class="col-md-6">
                                        <img src="{{ asset('public/storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$file->prev_bill) }}" alt="{{ $file->prev_bill }}" class="img-thumbnail">
                ...
                @if ($data->apply_type == 5 && $data->apply_sub_type == 2)
                <div class="container-fluid">
                    <div id="app_show" class="accordion" role="tablist" aria-multiselectable="true">
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                ...
                @if (chk_userForm($data->id)['to_confirm'])
                    @if (admin()->group_lvl == 1 && hasPermissions(['residentApplication-create'])) {{--  if login-user is from township  --}}
                    <div class="row justify-content-center m-t-20 m-b-10">
                        {{--  <div class="col-3">
                            <button class="btn btn-block btn-rounded btn-warning" data-toggle="modal" data-whatever="pending" data-target="#myModal" data-backdrop="static" data-keyboard="false" data-id="{{ route('contractorMeterFormPending.create', $data->id) }}">{{ __('lang.send_to_pending') }}</button> 
                        </div>
                        <div class="col-3">
                            <button class="btn btn-block btn-rounded btn-danger" data-toggle="modal" data-whatever="reject" data-target="#myModal" data-backdrop="static" data-keyboard="false" data-id="{{ route('contractorMeterFormErrorSend.create', $data->id) }}">{{ __('lang.send_to_user') }}</button> 
                        </div>  --}}
                        <div class="col-3">
                            <button class="btn btn-block btn-rounded btn-info {{ checkMM() }}" data-toggle="modal" data-whatever="accept" data-target="#myModal" data-backdrop="static" data-keyboard="false" data-id="{{ route('contractorMeterFormAccept.store', $data->id) }}">{{ __('lang.form_accept') }}</button>
                        </div>
                    </div>
                    @endif
                @endif
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                <h5 class="modal-title title-msg-resend mt-3 mb-3" id="exampleModalLabel">{{ __("lang.resend_title") }}</h5>
                <h5 class="modal-title title-msg-accept mt-3 mb-3" id="exampleModalLabel">{{ __("lang.accept_title") }}</h5>
                <hr/>
                <p class="body-msg-resend mt-5 mb-5">{{ __("lang.resend_msg") }}</p>
                <p class="body-msg-accept mt-5 mb-5">{{ __("lang.accept_msg") }}</p>
                <hr/>
