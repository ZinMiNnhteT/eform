                        ...
                        @foreach ($form as $data)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ route('contractorMeterRegisterMeterList.create', $data->id) }}" class="btn btn-warning btn-rounded btn-sm" data-toggle="tooltip" data-title="To Register Meter">
                                    ...
                                    <a href="{{ route('contractorMeterRegisterMeterList.show', $data->id) }}" class="btn btn-info btn-rounded btn-sm data-toggle="tooltip" data-title="View"><i class="fa fa-search fa-fw"></i></a>
                                    @endif
                                </td>
                                @endif
