                        ...
                        @foreach ($form as $data)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ route('contractorMeterGroundCheckDoneList.create', $data->id) }}" class="btn btn-warning btn-rounded btn-sm" data-toggle="tooltip" data-title="To Confirm Result"><i class="fa fa-edit fa-fw"></i></a>
                                    @endif
                                    
                                    @if (hasPermissions(['residentialChkGrdDone-show']))
                                    <a href="{{ route('contractorMeterGroundCheckDoneList.show', $data->id) }}" class="btn btn-info btn-rounded btn-sm" data-toggle="tooltip" data-title="View"><i class="fa fa-search fa-fw"></i></a>
                                    @endif
                                </td>
                                @endif
