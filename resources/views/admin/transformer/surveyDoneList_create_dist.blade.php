                ...
                <div class="row justify-content-center m-t-20">
                    <div class="col-md-10">
                        <div class="form-group">
                            ...
                            <textarea name="dist_remark" rows="5" class="form-control" id="dist_remark" placeholder="မှတ်ချက်ပေးရန်"></textarea>
                        </div>
                    </div>
                </div>

                <div class="text-center">
                    {{-- <a href="{{ route('transformerGroundCheckDoneListByDistrict.index') }}" class="btn btn-rounded btn-secondary">{{ __('lang.cancel') }}</a> --}}
                    ...
                    <input type="submit" name="survey_submit_district" value="{{ __('lang.send_pending') }}" class="btn btn-rounded btn-danger">
                    <input type="submit" name="survey_submit_district" value="{{ __('lang.send_reject') }}" class="btn btn-rounded btn-danger">
                </div>
                {!! Form::close() !!}
            </div>
        </div>
