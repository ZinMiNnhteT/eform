    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::open(['route' => 'transformerPaymentList.index', 'method' => 'get']) !!}
                <div class="row mb-3">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="{{ route('transformerPaymentList.index') }}" class="btn btn-rounded btn-warning"><i class="fa fa-refresh text-white"></i></a>
                    </div>
                </div>
                {!! Form::close() !!}
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                @if (hasPermissions(['transformerConfirmPayment-create', 'transformerConfirmPayment-show']))
                        ...
                        @foreach ($form as $data)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if (hasPermissions(['transformerConfirmPayment-show']))
                                    <a href="{{ route('transformerPaymentList.show', $data->id) }}" class="btn btn-{{ chk_userForm($data->id)['to_confirm_pay'] ? 'warning' : 'info' }} btn-rounded btn-sm" data-toggle="tooltip" data-title="View"><i class="fa fa-search fa-fw"></i></a>
                                    @endif
                                </td>
                                @endif
