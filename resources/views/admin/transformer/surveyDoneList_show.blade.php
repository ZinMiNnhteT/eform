            ...
            <div class="card-body card-body-pb-div">
                ...
                <div class="container-fluid">
                    <div id="app_show" class="accordion" role="tablist" aria-multiselectable="true">
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('pdf', $data->id) }}" class="btn btn-info btn-xs" target="_blank">save as pdf</a>
                                </div>
                            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table no-border table-md-padding">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th><strong>{{ __('ဓါတ်အားပေးမည့်ပင်ရင်း Source') }}</strong></th>
                                                        <td>
                                                            @if ($survey_result->pri_tsf_name)
                                                            {{ $survey_result->pri_tsf_name }}
                                                            @else
                                                            -
                                                            @endif
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <th><strong>{{ __('ဓါတ်အားပေးမည့် Secondary Source') }}</strong></th>
                                                        <td>
                                                            @if ($survey_result->sec_tsf_name)
                                                            {{ $survey_result->sec_tsf_name }}
                                                            @else
                                                            -
                                                            @endif
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <th><strong>{{ __('ဓါတ်အားရယူမည့် Feeder') }}</strong></th>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <th><strong>{{ __('ဓါတ်အားရယူမည့် လိုင်းတစ်လျှောက်ရှိ') }}</strong></th>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                    ...
                    <div class="card mb-1">
                        ...
                        <div class="card-body">
                            {!! Form::open(['route' => 'transformerGroundCheckDoneListByHeadOffice.store']) !!}
                            {!! Form::hidden('form_id', $data->id) !!}
                            <div class="row justify-content-center m-t-20">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <label for="head_remark" class="text-info">မှတ်ချက်</label>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center m-t-20">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <label for="dist_remark" class="text-info">မှတ်ချက်</label>
