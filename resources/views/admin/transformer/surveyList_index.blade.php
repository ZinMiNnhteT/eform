    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header bg-info text-white">
                <h5 class="card-title m-0 l-h-33">{{ __('lang.transformer') }} {{ __('lang.'.$heading) }}</h5>
            </div>
            ...
            <div class="card-body">
                ...
                {!! Form::open(['route' => 'transformerGroundCheckList.index', 'method' => 'get']) !!}
                <div class="row mb-3">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="{{ route('transformerGroundCheckList.index') }}" class="btn btn-rounded btn-warning"><i class="fa fa-refresh text-white"></i></a>
                    </div>
                </div>
                {!! Form::close() !!}
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                @if (hasPermissions(['transformerGrdChk-create', 'transformerGrdChk-show']))
                        ...
                        @foreach ($form as $data)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if (hasPermissions(['transformerGrdChk-show']))
                                    <a href="{{ route('transformerGroundCheckList.show', $data->id) }}" class="btn btn-{{ chk_userForm($data->id)['to_survey'] ? 'warning' : 'info' }} btn-rounded btn-sm" data-toggle="tooltip" data-title="View"><i class="fa fa-search fa-fw"></i></a>
                                    @endif
                                </td>
                                @endif
