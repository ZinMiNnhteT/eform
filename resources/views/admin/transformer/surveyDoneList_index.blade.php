    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::open(['route' => 'transformerGroundCheckDoneList.index', 'method' => 'get']) !!}
                <div class="row mb-3">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="{{ route('transformerGroundCheckDoneList.index') }}" class="btn btn-rounded btn-warning"><i class="fa fa-refresh text-white"></i></a>
                    </div>
                </div>
                {!! Form::close() !!}
                    ...
                    <table class="table table-hover table-strip">
                        <thead>
                            <tr>
                                ...
                                @if (hasPermissions(['transformerTownshipChkGrd-create', 'transformerTownshipChkGrd-show']))
                        ...
                        @foreach ($form as $data)
                            ...
                            {{--  chk same div/state  --}}
                            @if (admin()->div_state == $data->div_state_id || admin()->group_lvl <= 2)
                            ...
                            <tr>
                                ...
                                <td class="align-middle {{ chk_resend($data->id)['type'] == 'resend' ? 'text-danger' : chk_userForm($data->id)['color'] }}">
                                ...
                                <td class="text-center">
                                    @if (hasPermissions(['transformerTownshipChkGrd-show']))
                                    <a href="{{ route('transformerGroundCheckDoneList.show', $data->id) }}" class="btn btn-{{ chk_userForm($data->id)['to_confirm_survey'] ? 'warning' : 'info' }} btn-rounded btn-sm" data-toggle="tooltip" data-title="View"><i class="fa fa-search fa-fw"></i></a>
                                    @endif
                                </td>
                                @endif
