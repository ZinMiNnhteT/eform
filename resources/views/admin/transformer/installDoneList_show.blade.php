    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header text-white bg-info d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('transformerInstallationDoneList.index') }}" class="btn btn-rounded btn-info text-white l-h-ini p-t-5 p-b-5"><i class="fa-fw fa fa-angle-double-left"></i>{{ __('lang.back') }}</a>
                </div>
            </div>
            <div class="card-body card-body-pb-div">
                ...
                <div class="container-fluid">
                    ...
                    @if (chk_userForm($data->id)['ei_confirm'])
                        @if (hasPermissions(['transformerInstallDone-create']))
                    <div class="card mb-1">
                        <div class="card-header d-flex" role="tab" id="headingOne">
                        ...
                        <div class="card-body">
                            ...
                            <div class="container">
                                <div class="row form-group mb-1">
                                    ...
                                    <div class="col-md-7">
                                        <input type="file" required name="front[]" class="form-control" id="front" accept=".png,.jpg" multiple>
                                    </div>
                                </div>
                                <div class="row form-group mb-1">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <a href="{{ route('transformerInstallationDoneList.create', $data->id) }}" class="btn btn-rounded btn-info">{{ __('lang.send') }}</a>
            </div>
        </div>
    </div>
</div>
