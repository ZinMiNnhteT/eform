    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::open(['route' => 'residentialPowerMeterGroundCheckDoneListDist.store']) !!}
                ...
                <div class="row justify-content-center">
                    <div class="col-md-9">
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-md-6">
                                <p>{{ checkMM() == 'mm' ? mmNum($survey_result->distance) : $survey_result->distance }}</p>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-md-6">
                                <p>{{ $survey_result->prev_meter_no }}</p>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-md-6">
                                @if ($survey_result->transmit == null)
                                    -
                        ...
                        <div class="form-group row mb-1">
                            ...
                            <div class="col-md-6">
                                <p>{{ who($survey_result->survey_engineer) }}</p>
                            </div>
                        </div>
                ...
                <div class="text-center">
                    <a href="{{ url('residentialPowerMeterGroundCheckDoneList') }}" class="btn btn-rounded btn-secondary">{{ __('lang.cancel') }}</a>
                    <input type="submit" name="survey_submit" value="{{ __('lang.survey_confirm_send_tsp') }}" class="btn btn-rounded btn-info">
                </div>
                {!! Form::close() !!}
            </div>
        </div>
