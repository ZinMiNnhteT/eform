        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row justify-content-center mm">
                    <div class="col-8">
                        <h5 class="text-center"><b>အိမ်သုံးမီတာလျှောက်ထားခြင်းအတွက် ကျသင့်ငွေကောက်ခံခြင်း</b></h5>
                        <hr/>
                ...
                <div class="text-center">
                    <a href="{{ route('residentialPowerMeterPaymentList.index') }}" class="btn btn-rounded btn-secondary">{{ __('lang.cancel') }}</a>
