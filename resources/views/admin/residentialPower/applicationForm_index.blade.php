    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::open(['route' => 'residentialPowerMeterApplicationList.index', 'method' => 'get']) !!}
                <div class="row mb-3">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="{{ route('residentialPowerMeterApplicationList.index') }}" class="btn btn-rounded btn-warning"><i class="fa fa-refresh text-white"></i></a>
                    </div>
                </div>
                {!! Form::close() !!}
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                @if (hasPermissions(['residentPowerApplication-create', 'residentPowerApplication-show']))
                        ...
                        @foreach ($form as $data)
                            ...
                            <tr>
                                ...
                                @if (hasPermissions(['residentPowerApplication-show']))
                                <td class="text-center align-middle">
                                    <a href="{{ route('residentialPowerMeterApplicationList.show', $data->id) }}" class="btn btn-{{ chk_userForm($data->id)['to_confirm'] ? 'warning' : 'info' }}  btn-sm btn-rounded" data-toggle="tooltip" data-title="View"><i class="fa fa-search fa-fw"></i></a>
                                </td>
                                @endif
