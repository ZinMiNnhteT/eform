    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header text-white bg-info d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('residentialPowerMeterApplicationList.index') }}" class="btn btn-rounded btn-info text-white l-h-ini p-t-5 p-b-5"><i class="fa-fw fa fa-angle-double-left"></i>{{ __('lang.back') }}</a>
                </div>
            </div>
            <div class="card-body card-body-pb-div">
                ...
                @if (chk_userForm($data->id)['to_confirm'])
                    @if (admin()->group_lvl == 1 && hasPermissions(['residentPowerApplication-create'])) {{--  if login-user is from township  --}}
                <div class="row justify-content-center m-t-20 m-b-10">
                    <div class="col-3">
                        <button class="waves-effect waves-light btn btn-block btn-rounded btn-danger {{ checkMM() }}" data-toggle="modal" data-target="#myResendModal" data-backdrop="static" data-keyboard="false" data-id="{{ $data->id }}">{{ __('lang.send_to_user') }}</button> 
                    </div>
                    <div class="col-3">
                        <button class="waves-effect waves-light btn btn-block btn-rounded btn-info {{ checkMM() }}" data-toggle="modal" data-target="#myAcceptModal" data-backdrop="static" data-keyboard="false">{{ __('lang.form_accept') }}</button>
                    </div>
                </div>
                    @endif
                @endif
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <a href="{{ route('residentialPowerMeterFormAccept.store', $data->id) }}" class="waves-effect waves-light btn btn-rounded btn-info">{{ __('lang.approve') }}</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                {!! Form::open(['route' => 'residentialPowerMeterFormErrorSend.store']) !!}
