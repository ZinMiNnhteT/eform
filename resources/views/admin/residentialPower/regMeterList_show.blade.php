    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header text-white bg-info d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('residentialPowerMeterRegisterMeterList.index') }}" class="btn btn-rounded btn-info text-white l-h-ini p-t-5 p-b-5"><i class="fa-fw fa fa-angle-double-left"></i>{{ __('lang.back') }}</a>
                </div>
            </div>
            <div class="card-body card-body-pb-div">
                ...
                <div class="container-fluid">
                    ...
                    @if (chk_userForm($data->id)['to_register'])
                        @if (hasPermissions(['residentialPowerRegisteredMeter-create']))
                        ...
                        <div class="card-body mm">
                            ...
                            <div class="container">
                                ...
                                <label for="meter_no" class="control-label l-h-35 text-md-right col-md-3">{{ __('lang.meter_no') }}<span class="text-danger f-s-15">&#10039;</span></label></label>
                                <div class="col-md-7">
                                    {!! Form::text('meter_no', null, ['id' => 'meter_no', 'class' => 'form-control inner-form','required']) !!}
                                </div>
                            </div>
                            <div class="row form-group mb-1">
                                <label for="who_made_meter" class="control-label l-h-35 text-md-right col-md-3">{{ __('ထုတ်လုပ်သူအမှတ်') }}<span class="text-danger f-s-15">&#10039;</span></label></label>
                                <div class="col-md-7">
                                    {!! Form::text('who_made_meter', null, ['id' => 'who_made_meter', 'class' => 'form-control inner-form','required']) !!}
                                </div>
                            </div>
                            <div class="row form-group mb-1">
                                <label for="meter_no" class="control-label l-h-35 text-md-right col-md-3">{{ __('မီတာပြ ဂဏာန်း') }}<span class="text-danger f-s-15">&#10039;</span></label></label>
                                <div class="col-md-7">
                            ...
                            <div class="row form-group mb-1">
                                <label for="cover_seal_no" class="control-label l-h-35 text-md-right col-md-3">{{ __('Cover Seal') }}<span class="text-danger f-s-15">&#10039;</span></label></label>
                                <div class="col-md-7">
                                    {!! Form::text('cover_seal_no', null, ['id' => 'cover_seal_no', 'class' => 'form-control inner-form','required']) !!}
                                </div>
                            </div>
                            <div class="row form-group mb-1">
                                <label for="terminal_seal_no" class="control-label l-h-35 text-md-right col-md-3">{{ __('Terminal Seal') }}<span class="text-danger f-s-15">&#10039;</span></label></label>
                                <div class="col-md-7">
