    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header text-white bg-info d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('residentialPowerMeterAnnounceList.index') }}" class="btn btn-rounded btn-info text-white l-h-ini p-t-5 p-b-5"><i class="fa-fw fa fa-angle-double-left"></i>{{ __('lang.back') }}</a>
                </div>
            </div>
            <div class="card-body card-body-pb-div">
                ...
                @if (chk_userForm($data->id)['to_announce'])
                    @if (hasPermissions(['residentialPowerAnnounce-create']))
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <a href="{{ route('residentialPowerMeterAnnounceList.create', $data->id) }}" class="btn btn-rounded btn-info">{{ __('lang.send') }}</a>
            </div>
        </div>
    </div>
</div>
