            ...
            <div class="card-body card-body-pb-div">
                ...
                <div class="container-fluid">
                    ...
                    @if(hasSurvey($data->id))
                        @if (hasPermissions(['residentialPowerGrdChk-create']))
                            ...
                            <div class="row justify-content-center mt-3">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label for="curr_transmitter_volt" class="text-info">
                                                    {{ __('ဗို့အား') }} <span class="text-danger f-s-15"></span>
                                                </label>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group mt-4">
                                        <label for="comsumed_power_amt" class="text-info">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="power_tranformer" id="power_tranformer" class="form-control">
                                    </div>
                                </div>
