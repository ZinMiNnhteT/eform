            ...
            <div class="container">
                <div class="card-body">
                    <div class="text-md-right m-b-5">
                        <a href="{{ route('resident_applied_form_mdy', $form->id) }}" class="waves-effect waves-light btn btn-rounded btn-info "><< @lang('lang.back')</a>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    <td></td>
                                    <td>
                                        {!! Form::open(['route' => ['resident_update_meter_type_mdy'], 'method' => 'PATCH']) !!}
                                        {!! Form::hidden('sub_type', 1) !!}
                                        {!! Form::hidden('form_id', $form->id) !!}
                                        <button type="submit" class="waves-effect waves-light btn btn-rounded btn-outline-{{ $form->apply_sub_type == 1 ? 'warning' : 'info' }}">{{ __('lang.choose') }}</button>
                                        {!! Form::close() !!}
                                    </td>
                                    <td>
                                        {!! Form::open(['route' => ['resident_update_meter_type_mdy'], 'method' => 'PATCH']) !!}
                                        ...
                                        {!! Form::hidden('form_id', $form->id) !!}
                                        <button type="submit" class="waves-effect waves-light btn btn-rounded btn-outline-{{ $form->apply_sub_type == 2 ? 'warning' : 'info' }}">{{ __('lang.choose') }}</button>
                                        {!! Form::close() !!}
                                    </td>
                                    <td>
                                        {!! Form::open(['route' => ['resident_update_meter_type_mdy'], 'method' => 'PATCH']) !!}
                                        ...
                                        {!! Form::hidden('form_id', $form->id) !!}
                                        <button type="submit" class="waves-effect waves-light btn btn-rounded btn-outline-{{ $form->apply_sub_type == 3 ? 'warning' : 'info' }}">{{ __('lang.choose') }}</button>
                                        {!! Form::close() !!}
                                    </td>
                                </tr>
                            </tbody>
