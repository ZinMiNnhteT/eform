    ...
    <div class="col-md-8 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::open(['route' => ['contract_building_room_update_mdy'], 'method' => 'PATCH', 'files' => true]) !!}
            ...
            <div class="card-footer text-center">
                <a href="{{ route('contractor_applied_form_mdy',$c_form->application_form_id) }}" class="col-md-3 waves-effect waves-light btn btn-secondary btn-rounded mb-1">{{ __('lang.cancel') }}</a>
