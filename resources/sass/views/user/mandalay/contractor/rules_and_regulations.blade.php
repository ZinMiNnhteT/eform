        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="container">
                    <div class="m-t-10 mm" id="">
                        <ul class="pt-3 term-condition">
                            ...
                            <li>
                                <p>
                                    ကန်ထရိုက်တိုက်မီတာလျှောက်ထားရာတွင် ဝန်အားနိုင်နင်းမှုမရှိပါက ကိုယ်ပိုင်ထရန်စဖေါ်မာ တည်ဆောက်ရန်လိုအပ်ပြီး၊               မီတာတစ်လုံးစီအတွက် မီတာကြေး <span class="text-danger">(၉၀,၀၀၀ ကျပ်)</span> ပေးဆောင်ရမည် ဖြစ်ပါသည်။
                                </p>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="text-center">
                    ...
                    <a href="{{ route('contract_power_agreement_mdy') }}" class="waves-effect waves-light btn btn-rounded btn-info rr-accept disabled">{{ __('lang.continue') }}</a>
                </div>
            </div>
        </div>
    </div>
