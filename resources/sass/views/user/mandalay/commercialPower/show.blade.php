                    ...
                    <div id="app_show" class="accordion" role="tablist" aria-multiselectable="true">
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                @if (chk_send($form->id) !== 'first')
                                    @if ($form->serial_code)
                                <div class="ml-auto">
                                    <a href="{{ route('commercial_edit_user_info_mdy', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('commercial_edit_user_info_mdy', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                @if (chk_send($form->id) !== 'first')
                                <div class="ml-auto">
                                    <a href="{{ route('commercial_edit_meter_type_mdy', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('commercial_nrc_edit_mdy', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('commercial_nrc_edit_mdy', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('commercial_form10_edit_mdy', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('commercial_form10_edit_mdy', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('commercial_recomm_edit_mdy', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('commercial_recomm_edit_mdy', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('commercial_owner_edit_mdy', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('commercial_owner_edit_mdy', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('commercial_worklicence_edit_mdy', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('commercial_worklicence_edit_mdy', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                @if (chk_send($form->id) !== 'first')
                                    @if (chk_form_finish($form->id, $form->apply_type)['city_license'])
                                <div class="ml-auto">
                                    <a href="{{ route('commercial_power_city_license_edit_mdy', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('commercial_power_city_license_edit_mdy', $form->id) }}" class="btn-edit text-danger ">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                            <div id="city_license" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    ...
                                    <div class="col-md-6 text-center">
                                        <img src="{{ asset('storage/user_attachments/'.$form->id.'/'.$foto) }}" alt="{{ __('lang.city_license') }} ({{ checkMM()=='mm'?mmNum($i):$i }})" class="img-thumbnail" width="150" height="150" data-toggle="modal" data-target="#myImg">
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                @if (chk_send($form->id) !== 'first')
                                    @if (chk_form_finish($form->id, $form->apply_type)['ministry_permit'])
                                <div class="ml-auto">
                                    <a href="{{ route('commercial_power_ministry_permit_edit_mdy', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('commercial_power_ministry_permit_edit_mdy', $form->id) }}" class="btn-edit text-danger ">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                            <div id="ministry_permit" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    ...
                                    @endphp
                                            @foreach ($fotos as $foto)
                                    <div class="col-md-6 text-center">
                                        <img src="{{ asset('storage/user_attachments/'.$form->id.'/'.$foto) }}" alt="{{ __('lang.ministry_permit') }} ({{ checkMM()=='mm'?mmNum($i):$i }})" class="img-thumbnail" width="150" height="150" data-toggle="modal" data-target="#myImg">
