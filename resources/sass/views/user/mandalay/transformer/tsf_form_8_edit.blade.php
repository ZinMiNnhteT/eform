...
<div class="row justify-content-center py-5">
    <div class="col-md-8 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if($required == 'required')
                    ...
                    <br/>
                @endif
                {!! Form::open(['route' => 'tsf_electricpower_update_mdy', 'method' => 'PATCH', 'files' => true]) !!}
                {!! Form::hidden('form_id', $form_id, ['id' => 'form_id']) !!}
                <div class="row">
                    <div class="col-12">
                        <h4 class="card-title">{{ __('lang.dc_recomm') }} {!! $star !!}</h4>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
                ...
                @if ($files->count() > 0)
                    @foreach ($files as $file)
                        @if ($file->dc_recomm)
                            @php $data = explode(',', $file->dc_recomm); @endphp
        ...
        <div class="card-footer text-center">
            ...
            <a href="{{ route('tsf_applied_form_mdy', $form->id) }}" class="col-md-3 waves-effect waves-light btn btn-rounded btn-secondary">{{ __('lang.cancel') }}</a>
