            ...
            <div class="container-fluid">
                <div class="card-body">
                    <div class="text-md-right m-b-5">
                        <a href="{{ route('tsf_applied_form_ygn', $form->id) }}" class="waves-effect waves-light btn btn-rounded btn-info"><< {{ __('lang.back') }}</a>
                    </div>
                    @if ($fee_names->count() > 0)
                        
                    {!! Form::open(['route' => ['tsf_update_meter_type_ygn'], 'method' => 'PATCH']) !!} 
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="pole_type" class="text-dark m-l-10">
                                            <input name="pole_type" type="radio" value="1" class="check" id="flat-checkbox-1" data-checkbox="icheckbox_flat-red" required @if($form->pole_type == '1') checked @endif>
                                            {{ __('lang.one_pole')}}
                                        </label>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="pole_type" class="text-dark m-l-10">
                                            <input name="pole_type" type="radio" value="2" class="check" id="flat-checkbox-1" data-checkbox="icheckbox_flat-red" required @if($form->pole_type == '2') checked @endif>
                                            {{ __('lang.two_pole')}}
                                        </label>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="pole_type" class="text-dark m-l-10">
                                            <input name="pole_type" type="radio" value="3" class="check" id="flat-checkbox-1" data-checkbox="icheckbox_flat-red" required @if($form->pole_type == '3') checked @endif>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button type="submit" class="btn btn-rounded btn-outline-{{ $bg ? 'warning' : 'info' }} tsf-meter-type-choose" subtype="{{ $fee->sub_type }}">{{ __('lang.choose') }}</button>
