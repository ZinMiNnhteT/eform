        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="container">
                    <div class="m-t-10 mm" id="">
                        ...
                        <ul class="m-t-20 text-justify">
                            <p><strong>ကိုယ့်အားကိုယ်ကိုး ထရန်စဖေါ်မာတည်ဆောက်ခြင်းလုပ်ငန်းမှ ဓာတ်အားခွဲရုံတည်ဆောက်ခြင်းလုပ်ငန်းများအား အောက်ဖော်ပြပါ သတ်မှတ်ချက်များအတိုင်း ဆောင်ရွက်ရမည် ဖြစ်ပါသည်။</strong></p>
                            <li>
                                <p>ထရန်စဖေါ်မာတပ်ဆင်ထားသော နေရာသည် လွယ်ကူစွာ ကြည့်ရှုနိုင်သော ဝန်းခြံအရှေ့မျက်နှာစာ နေရာမျိုးဖြစ်ရမည်။</p>
                            </li>
                            <li>
                ...
                <div class="text-center">
                    ...
                    <a href="{{ route('commercial_tsf_agreement_ygn') }}" class="waves-effect waves-light btn btn-rounded btn-info rr-accept disabled ">{{ __('lang.continue') }}</a>
                </div>
            </div>
        </div>
    </div>
