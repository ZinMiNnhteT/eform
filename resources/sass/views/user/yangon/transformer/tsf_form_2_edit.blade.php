...
<div class="row justify-content-center">
    <div class="col-md-8 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                {!! Form::model($form, ['route' => ['tsf_update_user_info_ygn'], 'method' => 'PATCH', 'class' => 'mm']) !!}
                ...
                <div class="row justify-content-center">
                        ...
                        <div class="gStaff-wrapper {{ $form->job_type == 'gstaff' || $form->job_type == 'staff' ? : 'd-none' }}" id="gStaff-wrap">
                            <div class="form-group m-t-20">
                                ...
                                <div class="form-group m-t-20">
                                    ...
                                    <input type="number" name="salary" value="{{ $form->job_type == 'gstaff' || $form->job_type == 'staff' ? $form->salary : '' }}" id="salary" class="form-control" max="2147483647"/>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="row justify-content-center">
                            <div class="col-md-2">
                                <a href="{{ route('tsf_applied_form_ygn', $form->id) }}" class="waves-effect waves-light btn btn-block btn-rounded btn-secondary ">{{ __('lang.cancel') }}</a>
                            </div>
                            <div class="col-md-2">
