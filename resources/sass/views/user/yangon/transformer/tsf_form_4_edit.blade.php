        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if($required == 'required')
                    ...
                    <br/>
                @endif
                {!! Form::open(['route' => ['tsf_form10_update_ygn'], 'method' => 'PATCH', 'files' => true]) !!}
            ...
            <div class="card-footer text-center">
                <a href="{{ route('tsf_applied_form_ygn', $form_id) }}" class="col-md-3 waves-effect waves-light btn btn-secondary btn-rounded ">{{ __('lang.cancel') }}</a>
