    ...
    <div class="col-md-8 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::open(['route' => 'commercial_bill_store_ygn', 'files' => true]) !!}
            ...
            <div class="card-footer text-center">
                ...
                <a href="{{ route('commercial_farmland_create_ygn',$form_id) }}" class="waves-effect waves-light btn btn-info btn-rounded col-md-3">{{ __('lang.continue') }}</a>
            </div>
            {!! Form::close() !!}
        </div>
    </div>
