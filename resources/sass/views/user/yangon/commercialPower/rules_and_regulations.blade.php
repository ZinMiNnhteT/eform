    ...
    <div class="col-md-8 col-sm-12">
        <div class="card">
            <div class="card-header bg-primary">
                <h4 class="card-title text-center text-white {{ lang() }} m-0">{{ __('lang.'.$heading) }}</h4>
            </div>
            <div class="card-body">
                <div class="container">
                ...
                <div class="text-center">
                    ...
                    <a href="{{ route('all_meter_forms') }}" class="col-md-3 btn btn-rounded btn-secondary {{ lang() }}">{{ __('lang.cancel') }}</a>
                    <a href="{{ route('commercial_agreement_ygn') }}" class="col-md-3 btn btn-rounded btn-info rr-accept disabled {{ lang() }}">{{ __('lang.continue') }}</a>
                </div>
            </div>
        </div>
    </div>
