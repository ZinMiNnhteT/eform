        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if($required == 'required')
                    ...
                    <br/>
                @endif
                {!! Form::open(['route' => 'resident_power_building_photo_update_ygn', 'method' => 'PATCH', 'files' => true]) !!}
                {!! Form::hidden('form_id', $form_id, ['id' => 'form_id']) !!}
                    <div class="row">
                        <div class="col-12">
                            <h4 class="card-title ">{{ __('lang.building_photo') }} {!! $star !!}</h4>
                ...
                <div class="row m-t-10 m-b-10">
                    @foreach ($files as $file)
                        @if ($file->building)
                            @php $data = explode(',', $file->building); @endphp
                            @foreach ($data as $item)
            ...
            <div class="card-footer text-center">
                ...
                <a href="{{ route('resident_power_applied_form_ygn', $form->id) }}" class="waves-effect waves-light btn btn-secondary btn-rounded col-md-3">{{ __('lang.cancel') }}</a>
