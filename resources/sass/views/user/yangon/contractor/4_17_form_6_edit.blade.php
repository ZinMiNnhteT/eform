        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if($required == 'required')
                    ...
                    <br/>
                @endif
                {!! Form::open(['route' => ['417_permit_update_ygn'], 'method' => 'PATCH', 'files' => true]) !!}
                {!! Form::hidden('form_id', $form_id) !!}
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <div class="form-group m-0">
                            <p class="card-title">{{ __('lang.permit_photo') }} {!! $star !!}</p>
                        </div>
            ...
            <div class="card-footer text-center">
                <a href="{{ route('contractor_applied_form_ygn', $form_id) }}" class="col-md-3 waves-effect waves-light btn btn-secondary btn-rounded">{{ __('lang.cancel') }}</a>
