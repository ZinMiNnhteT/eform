        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if($required == 'required')
                    ...
                    <br/>
                @endif
                {!! Form::open(['route' => 'contractor_farmland_update_ygn', 'method' => 'PATCH', 'files' => true]) !!}
            ...
            <div class="card-footer text-center">
                ...
                <a href="{{ route('contractor_applied_form_ygn', $form->id) }}" class="waves-effect waves-light btn btn-secondary btn-rounded col-md-3">{{ __('lang.cancel') }}</a>
