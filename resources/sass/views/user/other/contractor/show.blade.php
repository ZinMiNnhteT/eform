                    ...
                    <div id="app_show" class="accordion" role="tablist" aria-multiselectable="true">
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                @if (chk_send($form->id) !== 'first')
                                    @if ($form->serial_code)
                                <div class="ml-auto">
                                    <a href="{{ route('417_edit_user_info', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('417_edit_user_info', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                @if (chk_send($form->id) !== 'first')
                                <div class="ml-auto">
                                    <a href="{{ route('contract_building_room_edit', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('417_nrc_edit', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('417_nrc_edit', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('417_form10_edit', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('417_form10_edit', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('417_recomm_edit', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('417_recomm_edit', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('417_owner_edit', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('417_owner_edit', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('417_permit_edit', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('417_permit_edit', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('417_bcc_edit', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('417_bcc_edit', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('417_dc_recomm_edit', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('417_dc_recomm_edit', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                ...
                                <div class="ml-auto">
                                    <a href="{{ route('417_bill_edit', $form->id) }}" class="btn-edit text-info">{{ __('lang.create') }}</a>
                                </div>
                                    @else
                                <div class="ml-auto">
                                    <a href="{{ route('417_bill_edit', $form->id) }}" class="btn-edit text-danger">{{ __('lang.edit') }}</a>
                                </div>
                                    @endif
                                @endif
                            </div>
