        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-10">
                        <div class="table-responsive bg-secondary">
                            <table class="table no-border">
                                <thead>
                                    <tr>
                                        <th colspan="2" class="text-center text-dark">
                                            <h4>မြို့နယ်အဆင့်စစ်ဆေးခြင်း</h4>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $survey_result->latitude }} , {{ $survey_result->longitude }}</td>
                                    </tr>
                                    <tr>
                                        <td>{{ __('lang.attach_file_location') }}</td>
                                        <td>
                                ...
                                <tbody>
                                    <tr>
                                        <td>{{ __('lang.bq_cost') }} ({{ __('lang.kyat') }}) {{ __('lang.bq_confirm') }}</td>
                                        <td>
                ...
                <div class="text-center">
                    <a href="{{ route('contractorMeterGroundCheckDoneListByDivisionState.index') }}" class="btn btn-rounded btn-secondary">{{ __('lang.cancel') }}</a>
