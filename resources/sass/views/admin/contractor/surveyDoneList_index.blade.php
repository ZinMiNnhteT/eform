                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                @if (hasPermissions(['contractorTownshipChkGrd-create', 'contractorTownshipChkGrd-show']))
                        ...
                        @foreach ($form as $data)
                            ...
                            <tr>
                                ...
                                <td class="align-middle {{ chk_resend($data->id)['type'] == 'resend' ? 'text-danger' : chk_userForm($data->id)['color'] }}" width="20%">
                                ...
                                <td class="text-center">
                                    @if (hasPermissions(['contractorTownshipChkGrd-show']))
                                    <a href="{{ route('contractorMeterGroundCheckDoneList.show', $data->id) }}" class="btn btn-{{ chk_userForm($data->id)['to_confirm_survey'] ? 'warning' : 'info' }} btn-rounded btn-sm" data-toggle="tooltip" data-title="View"><i class="fa fa-search fa-fw"></i></a>
                                    @endif
                                </td>
                                @endif
