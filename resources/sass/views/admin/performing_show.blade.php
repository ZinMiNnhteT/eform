    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header text-white bg-info d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('performing_form.index') }}" class="btn btn-rounded btn-info text-white l-h-ini p-t-5 p-b-5"><i class="fa-fw fa fa-angle-double-left"></i>{{ __('lang.back') }}</a>
                </div>
            </div>
                ...
                <div class="container-fluid">
                    ...
                    <div id="app_show" class="accordion" role="tablist" aria-multiselectable="true">
                                    ...
                                    <div class="card-body mm">
                                        ...
                                        <div class="p-t-10">
                                            <h6 class="l-h-35">
                                                ...
                                                အထက်ပါကိစ္စနှင့်ပတ်သက်၍ {{ address_mm($data->id) }}နေ ကျွန်တော်/ကျွန်မ၏ <b>{{ $data->applied_building_type ? building_type_mm($data->applied_building_type) : '<span class="p-l-40"></span>' }}</b> တွင် (အိမ်သုံး) မီတာတစ်လုံး တပ်ဆင်သုံးစွဲခွင့်ပြုပါရန် လျှောက်ထားအပ်ပါသည်။
                                            </h6>
                                            <h6 class="l-h-35">
                        ...
                        <div class="card mb-1">
                            ...
                            <div id="nrc" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    <div class="col-md-6">
                                        <img src="{{ asset('storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$file->nrc_copy_front) }}" alt="{{ $file->nrc_copy_front }}" class="img-thumbnail">
                                        <p class="{{ lang() }} m-t-10 m-b-10">{{ __('lang.nrc_front') }}</p>
                                    </div>
                                    <div class="col-md-6">
                                        <img src="{{ asset('storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$file->nrc_copy_back) }}" alt="{{ $file->nrc_copy_back }}" class="img-thumbnail">
                                        <p class="{{ lang() }} m-t-10 m-b-10">{{ __('lang.nrc_back') }}</p>
                                    </div>
                                </div>
                                @endforeach
                            </div>
                        ...
                        <div class="card mb-1">
                            ...
                            <div id="form10" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    <div class="col-md-6">
                                        <img src="{{ asset('storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$file->form_10_front) }}" alt="{{ $file->form_10_front }}" class="img-thumbnail">
                                        <p class="{{ lang() }} m-t-10 m-b-10">{{ __('lang.form10_front') }}</p>
                                    </div>
                                    
                                    @if ($file->form_10_back)
                                    <div class="col-md-6">
                                        <img src="{{ asset('storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$file->form_10_back) }}" alt="{{ $file->form_10_back }}" class="img-thumbnail">
                                        <p class="{{ lang() }} m-t-10 m-b-10">{{ __('lang.form10_back') }}</p>
                                    </div>
                                    @endif
                                </div>
                                @endforeach
                        ...
                        <div class="card mb-1">
                            ...
                            <div id="recommanded_letter" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    <div class="col-md-6">
                                        <img src="{{ asset('storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$file->occupy_letter) }}" alt="{{ $file->occupy_letter }}" class="img-thumbnail">
                                        <p class="{{ lang() }} m-t-10 m-b-10">{{ __('lang.occupy_letter') }}</p>
                                    </div>
                                    <div class="col-md-6">
                                        <img src="{{ asset('storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$file->no_invade_letter) }}" alt="{{ $file->no_invade_letter }}" class="img-thumbnail">
                                        <p class="{{ lang() }} m-t-10 m-b-10">{{ __('lang.noinvade_letter') }}</p>
                                    </div>
                                </div>
                                @endforeach
                            </div>
                            ...
                            <div id="owner_letter" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    ...
                                    <div class="col-md-6 text-center">
                                        <img src="{{ asset('storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$foto) }}" alt="{{ $foto }}" class="img-thumbnail">
                                        <p class="{{ lang() }} m-t-10 m-b-10">{{ __('lang.owner_photo') }} ({{ checkMM()=='mm'?mmNum($i):$i }})</p>
                                    </div>
                                    @php
                                        $i++;
                                    @endphp
                    ...
                    <div id="app_show" class="accordion" role="tablist" aria-multiselectable="true">
                                ...
                                <div class="container">
                                    <div class="card-body mm">
                                        ...
                                        <div class="p-t-10">
                                            <h6 class="l-h-35">
                                                <span class="p-l-40"></span><span class="p-l-40"></span>
                                                အထက်ပါကိစ္စနှင့်ပတ်သက်၍ {{ address_mm($data->id) }}နေ ကျွန်တော်/ကျွန်မ၏ <b>{{ $data->applied_building_type ? building_type_mm($data->applied_building_type) : '<span class="p-l-40"></span>' }}</b> တွင် {{ power_meter_type($data->id) }} တပ်ဆင်သုံးစွဲခွင့်ပြုပါရန် လျှောက်ထားအပ်ပါသည်။
                                            </h6>
                                            <h6 class="l-h-35">
                                                <span class="p-l-40"></span><span class="p-l-40"></span> တပ်ဆင်သုံးစွဲခွင့်ပြုပါက လျှပ်စစ်ဓာတ်အားဖြန့်ဖြူးရေးလုပ်ငန်းမှ သတ်မှတ်ထားသော အခွန်အခများကို အကြေပေးဆောင်မည့်အပြင် တည်ဆဲဥပဒေများအတိုင်း လိုက်နာဆောင်ရွက်မည်ဖြစ်ပါကြောင်းနှင့် အိမ်တွင်းဝါယာသွယ်တန်းခြင်းလုပ်ငန်းများကို လျှပ်စစ်ကျွမ်းကျင်လက်မှတ်ရှိသူများနှင့်သာ ဆောင်ရွက်မည်ဖြစ်ကြောင်း ဝန်ခံကတိပြုလျှောက်ထားအပ်ပါသည်။
                                            </h6>
                        ...
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                <h5 class="mb-0">
                                    <a data-toggle="collapse" data-parent="#app_show" href="#electricpower_letter" aria-expanded="true" aria-controls="collapseOne">{{ __('lang.applied_electricpower_photo') }}</a>
                                </h5>
                            </div>
                            <div id="electricpower_letter" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    @php
                                        $power_foto = explode(',', $file->electric_power);
                                        $i = 1;
                                    @endphp
                                    @foreach ($power_foto as $foto)
                                    <div class="col-md-6 text-center">
                                        <img src="{{ asset('storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$foto) }}" alt="{{ $foto }}" class="img-thumbnail">
                                        <p class="{{ lang() }} m-t-10 m-b-10">{{ __('lang.electricpower_photo') }} ({{ checkMM()=='mm'?mmNum($i):$i }})</p>
                                    </div>
                                    @php
                                        $i++;
                                    @endphp
                               ...
                               <div class="container">
                                   <div class="card-body mm">
                                       ...
                                       <div class="p-t-10">
                                           <h6 class="l-h-35">
                                               <span class="p-l-40"></span><span class="p-l-40"></span>
                                               အထက်ပါကိစ္စနှင့်ပတ်သက်၍ {{ address_mm($data->id) }}နေ ကျွန်တော်/ကျွန်မ၏ <b>{{ $data->applied_building_type ? building_type_mm($data->applied_building_type) : '<span class="p-l-40"></span>' }}</b> တွင် {{ cpower_meter_type($data->id) }} တပ်ဆင်သုံးစွဲခွင့်ပြုပါရန် လျှောက်ထားအပ်ပါသည်။
                                           </h6>
                                           <h6 class="l-h-35">
                                               <span class="p-l-40"></span><span class="p-l-40"></span> တပ်ဆင်သုံးစွဲခွင့်ပြုပါက လျှပ်စစ်ဓာတ်အားဖြန့်ဖြူးရေးလုပ်ငန်းမှ သတ်မှတ်ထားသော အခွန်အခများကို အကြေပေးဆောင်မည့်အပြင် တည်ဆဲဥပဒေများအတိုင်း လိုက်နာဆောင်ရွက်မည်ဖြစ်ပါကြောင်းနှင့် အိမ်တွင်းဝါယာသွယ်တန်းခြင်းလုပ်ငန်းများကို လျှပ်စစ်ကျွမ်းကျင်လက်မှတ်ရှိသူများနှင့်သာ ဆောင်ရွက်မည်ဖြစ်ကြောင်း ဝန်ခံကတိပြုလျှောက်ထားအပ်ပါသည်။
                                           </h6>
                       ...
                       <div class="card mb-1">
                           ...
                           <div id="transaction_letter" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                               ...
                               <div class="row text-center mt-2">
                                   ...
                                   <div class="col-md-6 text-center">
                                       <img src="{{ asset('storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$foto) }}" alt="{{ $foto }}" class="img-thumbnail">
                                       <p class="{{ lang() }} m-t-10 m-b-10">{{ __('lang.transactionlicence_photo') }} ({{ checkMM()=='mm'?mmNum($i):$i }})</p>
                                   </div>
                                   @php
                                   $i++;
                                   @endphp
                    ...
                    @elseif($data->apply_type == 5 && $data->apply_sub_type == 1)
                    <div id="app_show" class="accordion" role="tablist" aria-multiselectable="true">
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                <h5 class="mb-0">
                        ...
                        <div class="card mb-1">
                            ...
                            <div id="recommanded_letter" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    ...
                                    <div class="col-md-6">
                                        <img src="{{ asset('storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$file->no_invade_letter) }}" alt="{{ $file->noinvade_letter }}" class="img-thumbnail">
                        ...
                        <div class="card mb-1">
                            ...
                            <div id="permit_letter" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    <div class="col-md-6">
                                        <img src="{{ asset('storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$file->building_permit) }}" alt="{{ $file->building_permit }}" class="img-thumbnail">
                        ...
                        <div class="card mb-1">
                            ...
                            <div id="bcc_letter" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    <div class="col-md-6">
                                        <img src="{{ asset('storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$file->bcc) }}" alt="{{ $file->bcc }}" class="img-thumbnail">
                        ...
                        <div class="card mb-1">
                            ...
                            <div id="dc_recomm_letter" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    <div class="col-md-6">
                                        <img src="{{ asset('storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$file->dc_recomm) }}" alt="{{ $file->dc_recomm }}" class="img-thumbnail">
                        ...
                        <div class="card mb-1">
                            ...
                            <div id="prev_bill_letter" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                ...
                                <div class="row text-center mt-2">
                                    <div class="col-md-6">
                                        <img src="{{ asset('storage/user_attachments/'.$data->id.'_'.$data->serial_code.'/'.$file->prev_bill) }}" alt="{{ $file->prev_bill }}" class="img-thumbnail">
                    ...
                    @elseif($data->apply_type == 5 && $data->apply_sub_type == 2)
                    <div id="app_show" class="accordion" role="tablist" aria-multiselectable="true">
                        <div class="card mb-1">
                            <div class="card-header d-flex" role="tab" id="headingOne">
                                <h5 class="mb-0">
                        ...
                        <div class="card mb-1">
                            ...
                            <div id="residentSurvey" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                <div class="container">
                                    <div class="talbe-responsive p-20">
                                        <table class="table">
                                            @if($formActionData->survey_accepted_date)
                                            <tr>
                                            ...
                                            @else
                                            <tr>
                                                <th width="50%" colspan="3">{{__('lang.residentSurvey')}} {{__('lang.directing')}}</th>
                                            </tr>
                                            @endif
                                            <tr>
