    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header bg-info text-white d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('commercialPowerMeterCheckInstallList.index') }}" class="btn btn-rounded btn-info text-white l-h-ini p-t-5 p-b-5"><i class="fa-fw fa fa-angle-double-left"></i>{{ __('lang.back') }}</a>
                </div>
            </div>
            ...
            <div class="card-body mm">
                ...
                {!! Form::open(['route' => 'commercialPowerMeterCheckInstallList.store']) !!}
                ...
                <div class="text-center mt-5">
                    <a href="{{ route('commercialPowerMeterCheckInstallList.index') }}" class="btn btn-rounded btn-secondary">{{ __('lang.cancel') }}</a>
