    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body mm">
                ...
                {!! Form::open(['route' => 'residentialPowerMeterContractList.store']) !!}
                <div class="row mt-5">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="applied_type" class="form-control mm" id="type" required="required">
                                <option value="" disabled="disabled" selected="selected">ရွေးချယ်ရန်</option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="elec_type" class="form-control mm" required="required">
                                <option value="" disabled="disabled" selected="selected">ရွေးချယ်ရန်</option>
                ...
                <div class="row justify-content-center m-t-20 m-b-10">
                    <div class="col-3">
                        <a href="{{ url('residentialPowerMeterContractList') }}" class="btn btn-block btn-rounded btn-secondary {{ lang() }}">@lang('lang.cancel')</a>
                    </div>
                    <div class="col-3">
