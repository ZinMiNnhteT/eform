    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header text-white bg-info d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('residentialPowerMeterContractList.index') }}" class="btn btn-rounded btn-info text-white l-h-ini p-t-5 p-b-5"><i class="fa-fw fa fa-angle-double-left"></i>{{ __('lang.back') }}</a>
                </div>
            </div>
            <div class="card-body card-body-pb-div">
                ...
                @if (chk_userForm($data->id)['to_contract'])
                    @if (hasPermissions(['residentialPowerContract-create']))
                    <div class="row justify-content-center m-t-20 m-b-10">
                        <div class="col-3">
                            <a href="{{ route('residentialPowerMeterContractList.create', $data->id) }}" class="btn btn-rounded btn-block btn-warning" data-toggle="tooltip" data-title="To Contract">
                                {{ __('lang.survey') }}
                            </a>
                        </div>
                    </div>
