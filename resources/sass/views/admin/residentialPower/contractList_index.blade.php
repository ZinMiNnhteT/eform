    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::open(['route' => 'residentialPowerMeterContractList.index', 'method' => 'get']) !!}
                <div class="row mb-3">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="{{ route('residentialPowerMeterContractList.index') }}" class="btn btn-rounded btn-warning"><i class="fa fa-refresh text-white"></i></a>
                    </div>
                </div>
                {!! Form::close() !!}
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                @if (hasPermissions(['residentialPowerContract-create', 'residentialPowerContract-show']))
                        ...
                        @foreach ($form as $data)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ route('residentialPowerMeterContractList.create', $data->id) }}" class="btn btn-warning btn-sm btn-rounded" data-toggle="tooltip" data-title="To Contract">
                                        <i class="fa fa-pencil-square-o fa-fw"></i>
                                    </a>
                                        @endif
                                    @endif
                                    
                                    @if (hasPermissions(['residentialPowerContract-show']))
                                    <a href="{{ route('residentialPowerMeterContractList.show', $data->id) }}" class="btn btn-info btn-sm btn-rounded" data-toggle="tooltip" data-title="View"><i class="fa fa-search fa-fw"></i></a>
                                    @endif
                                </td>
                                @endif
