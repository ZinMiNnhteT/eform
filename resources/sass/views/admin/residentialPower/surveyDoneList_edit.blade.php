    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header text-white bg-info d-flex">
                <h5 class="card-title m-b-0">{{ __('lang.'.$heading) }}</h5>
                <div class="ml-auto">
                ...
                <div class="row justify-content-center mt-3">
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="curr_transmitter_date" name="curr_transmitter_date" value="{{ $survey_result->curr_transmitter_date != "" ? date('d-m-Y', strtotime($survey_result->curr_transmitter_date)) : "" }}" class="form-control mydatepicker">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="curr_transmitter_time" name="curr_transmitter_time" value="{{ $survey_result->curr_transmitter_date != "" ? date('H:i', strtotime($survey_result->curr_transmitter_date)) : "" }}" class="form-control timepicker">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                        ...
                        <div class="form-group mt-4">
                            ...
                            {!! Form::file('line_map_400',['class' => 'form-control', 'accept' => '.jpg,.png,.pdf']) !!}
                            @if ($survey_result->line_map_400)
                                <div class="row" style="padding-top: 10px;">
                                    <?php 
                                        $foto       = $survey_result->line_map_400;
                                        $filename   = asset('storage/user_attachments/'.$form->id.'/'.$foto);
                                        $ext = pathinfo($filename, PATHINFO_EXTENSION);
                                        ;
                                    ?>
