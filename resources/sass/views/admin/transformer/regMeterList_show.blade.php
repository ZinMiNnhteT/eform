            ...
            <div class="card-body card-body-pb-div">
                ...
                <div class="container-fluid">
                    ...
                    @if (chk_userForm($data->id)['to_register'])
                        @if (hasPermissions(['transformerRegisteredMeter-create']))
                    <div class="card mb-1">
                        <div class="card-header d-flex" role="tab" id="headingOne">
                            <h5 class="mb-0 text-info">{{ __('မီတာမှတ်ပုံတင်ခြင်း') }}</h5>
                        </div>
                        <div class="card-body">
                            <h5 class="py-2 text-danger text-center ">{{ __('lang.required_msg') }}</h5>
                            {!! Form::open(['route' => 'transformerRegisterMeterList.store']) !!}
                            ...
                            <div class="container">
                                ...
                                <div class="row form-group mb-1">
                                    ...
                                    <div class="col-md-7">
                                        {!! Form::text('meter_unit_no', null, ['id' => 'meter_unit_no', 'class' => 'form-control inner-form','requried']) !!}
                                    </div>
                                </div>
