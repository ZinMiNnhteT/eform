    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header bg-info text-white">
                <h5 class="card-title m-0">{{ __('lang.transformer') }} {{ __('lang.'.$heading) }} {{ __('lang.forms') }}</h5>
            </div>
            ...
            <div class="card-body">
                ...
                {!! Form::open(['route' => 'transformerRejectedForm.index', 'method' => 'get']) !!}
                <div class="row mb-3">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="{{ route('transformerRejectedForm.index') }}" class="btn btn-rounded btn-warning"><i class="fa fa-refresh text-white"></i></a>
                    </div>
                </div>
                {!! Form::close() !!}
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                @if (hasPermissions(['transformerReject-create', 'transformerReject-show']))
                        ...
                        @foreach ($form as $data)
                            ...
                            <tr>
                                ...
                                @if (hasPermissions(['transformerReject-show']))
                                <td class="text-center align-middle">
                                    <a href="{{ route('transformerRejectedForm.show', $data->id) }}" class="btn btn-rounded btn-sm btn-{{ chk_userForm($data->id)['to_confirm'] ? 'warning' : 'info' }}" data-toggle="tooltip" data-title="View"><i class="fa fa-search fa-fw"></i></a>
                                </td>
                                @endif
