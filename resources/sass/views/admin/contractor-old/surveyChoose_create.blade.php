        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row justify-content-center m-t-20">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="engineer_name" class="text-info">
                                {{ __('lang.eng_choose') }}
                            </label>
                            <select name="engineer_id" id="engineer_name" class="form-control {{ checkMM() }}" required>
                ...
                <div class="text-center">
                    <a href="{{ route('residentialMeterGroundCheckList.index') }}" class="btn btn-rounded btn-secondary">@lang('lang.cancel')</a>
