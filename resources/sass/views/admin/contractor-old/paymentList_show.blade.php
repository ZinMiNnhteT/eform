            ...
            <div class="card-body card-body-pb-div">
                ...
                @if (chk_userForm($data->id)['to_confirm_pay'])
                    ...
                    <div class="row justify-content-center m-t-20 m-b-10">
                        <div class="col-3">
                            <a href="{{ route('contractorMeterPaymentList.create', $data->id) }}" class="btn btn-rounded btn-block btn-warning" data-toggle="tooltip" data-title="To Accept Payment">
                                {{ __('lang.confirm_payment') }}
                            </a>
                        </div>
                    </div>
                    @endif
