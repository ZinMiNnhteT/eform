    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::open(['route' => 'reject_form.index','method'=>'get']) !!}
                    <div class="row">
                        <div class="col-md-3">
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                @if (hasPermissions(['rejectForm-create', 'rejectForm-show']))
                        ...
                        @foreach ($form as $data)
                            ...
                            <tr>
                                ...
                                @if (hasPermissions(['rejectForm-show']))
                                <td class="text-center align-middle">
                                    <a href="{{ route('reject_form.show', $data->id) }}" class="btn btn-rounded btn-sm btn-{{ chk_userForm($data->id)['to_confirm'] ? 'warning' : 'info' }}" data-toggle="tooltip" data-title="View"><i class="fa fa-search fa-fw"></i></a>
                                </td>
                                @endif
