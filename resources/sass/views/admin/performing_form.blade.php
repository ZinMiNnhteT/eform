    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::open(['route' => 'performing_form.index','method'=>'get','id'=>'myForm']) !!}
                    <div class="row">
                        <div class="col-md-2">
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="">{{ __('lang.status') }}</th>
                                @if (hasPermissions('performingForm-show'))
                        ...
                        @foreach ($form as $data)
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle">
                                    <a href="{{ route('performing_form.show', $data->id) }}" class="btn btn-rounded btn-sm btn-{{ chk_userForm($data->id)['to_confirm'] ? 'warning' : 'info' }}" data-toggle="tooltip" data-title="View"><i class="fa fa-search fa-fw"></i></a>
                                </td>
                                @endif
                        ...
                        @else
                            <tr class="text-center">
                                <td colspan="10">{{ 'There is nothing to show!' }}</td>
                            </tr>
                        @endif
                        </tbody>
                    </table>
