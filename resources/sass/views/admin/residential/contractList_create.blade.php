    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body mm">
                ...
                {!! Form::open(['route' => 'residentialMeterContractList.store']) !!}
                <div class="row mt-5">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('building_type', building_type_mm($form->applied_building_type), ['id' => 'building_type', 'class' => 'form-control inner-form', 'readonly']) !!}
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::textarea('payment_address', address_mm($form->id), ['id' => 'payment_address_16', 'class' => 'form-control inner-form', 'rows' => '4', 'readonly']) !!}
                        </div>
                ...
                <div class="row justify-content-center m-t-20 m-b-10">
                    <div class="col-3">
                        <a href="{{ url('residentialMeterAnnounceList') }}" class="btn btn-block btn-rounded btn-secondary {{ lang() }}">@lang('lang.cancel')</a>
                    </div>
                    <div class="col-3">
