    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header text-white bg-info d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('residentialMeterAnnounceList.index') }}" class="btn btn-rounded btn-info text-white l-h-ini p-t-5 p-b-5"><i class="fa-fw fa fa-angle-double-left"></i>{{ __('lang.back') }}</a>
                </div>
            </div>
            <div class="card-body card-body-pb-div">
                ...
                @if (chk_userForm($data->id)['to_announce'])
                    ...
                    <div class="row justify-content-center m-t-20 m-b-10">
                        <div class="col-3">
                            <button class="btn btn-rounded btn-block btn-warning" data-toggle="modal" data-target="#announce" data-backdrop="static" data-keyboard="false" title="To Announce To User">{{ __('lang.announce') }}</button>
                        </div>
                    </div>
                    @endif
                @endif
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <a href="{{ route('residentialMeterAnnounceList.create', $data->id) }}" class="btn btn-rounded btn-warning">{{ __('lang.send') }}</a>
            </div>
        </div>
    </div>
</div>
