...
class CreateFormSurveyTransformersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('form_survey_transformers', function (Blueprint $table) {
            ...
            $table->string('p_tsf_type')->nullable();
            $table->string('p_tsf_name')->nullable();
            $table->string('p_capacity')->nullable();
            $table->string('p_main_ct_ratio')->nullable();
            $table->string('p_main_ct_ratio_amt')->nullable();
            $table->string('p_11_main_ct_ratio')->nullable();
            $table->string('p_11_peak_load_day')->nullable();
            $table->string('p_11_peak_load_night')->nullable();
            $table->string('p_11_installed_capacity')->nullable();
            ...
            $table->text('string_new_type_length')->nullable();
            ...
            $table->string('tsp_recomm')->nullable();
            $table->text('dist_remark')->nullable();
            $table->string('dist_recomm')->nullable();
            $table->string('capacitor_bank')->nullable();
            $table->string('capacitor_bank_amt')->nullable();
            $table->string('outfit_meter')->nullable();
            $table->string('vcd')->nullable();
            $table->string('load_break_switch')->nullable();
            $table->text('div_state_remark')->nullable();
            $table->string('div_state_recomm')->nullable();
            $table->text('head_office_remark')->nullable();
            $table->string('head_office_recomm')->nullable();
            $table->timestamps();
