...
$.post(window.location.origin + "/emeter/chart_with_database", function(e) {
    console.log(e);
});
console.log(window.location.origin + "/emeter/chart_with_database");
option = {
    tooltip : {
        trigger: 'axis'
    },
    // legend: {
    //     data:['Registered Users','Forms']
    // },
    // toolbox: {
    //     show : true,
    //     feature : {
